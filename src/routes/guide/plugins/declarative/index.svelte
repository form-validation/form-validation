...
`} />         
    ...
    <section class="mv5">
        ...
        <ul class="pa0 ma0 ml3 lh-copy">
            <li>v1.7.0: Parse validator options of element attributes when a field is added via the <a href="/guide/api/add-field" class="blue dim link">addField()</a> method</li>
