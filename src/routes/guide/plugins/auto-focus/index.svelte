<svelte:head>
	<title>FormValidation • AutoFocus plugin</title>
</svelte:head>

<GuideLayout>
    <h1 class="f3 f2-m f1-l tc">AutoFocus plugin</h1>
    <h2 class="f4 fw4 tc">Focus on the first invalid element when submit form</h2>
