<TachyonsLayout>
    <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/bic/basic" on:received={receive}>
        <form id="demoForm" method="post">
            <div class="cf mb2">
                <div class="fl w-100">
                    <div class="fl w-25 pa2">BIC</div>
                    <div class="fl w-50">
                        <input type="text" bind:this={inputEle} name="bic" class="input-reset ba b--black-20 pa2 mb2 db w-100" />
                    </div>
                </div>
            </div>
        </form>
    ...
    fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/validators/bic/basic/Tachyons',
