<svelte:head>
	<title>FormValidation • siret validator</title>
</svelte:head>

<GuideLayout>
    <h1 class="f3 f2-m f1-l tc">siret validator</h1>
    <h2 class="f4 fw4 tc">Validate a <a href="https://en.wikipedia.org/wiki/SIRET_code" class="blue dim link">Siret number</a></h2>
    ...
    <section class="mv5">
        ...
        <table class="collapse ba br2 b--black-10 pv2 ph3 w-100">
            ...
            <tr class="striped--light-gray">
                ...
                <td class="pv2 ph3"><code>data-fv-siret___message</code></td>
...
`} />
    ...
    <RelatedValidators validators={['siren']} />

    <section class="mv5">
        <div class="flex">
            <PrevButton target="/guide/validators/siren">siren validator</PrevButton>
            <NextButton target="/guide/validators/step">step validator</NextButton>
        </div>
    </section>
</GuideLayout>
