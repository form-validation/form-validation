...
`} />
    ...
    <section class="mv5">
        <div class="flex">
            <PrevButton href="/guide/validators/uuid/">uuid validator</PrevButton>
            <NextButton href="/guide/validators/vat/{slug(data[0].adjective)}-vat-number/">{data[0].adjective} vat validator</NextButton>
        </div>
    </section>
</GuideLayout>
