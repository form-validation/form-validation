<svelte:head>
	<title>FormValidation • base64 validator</title>
</svelte:head>

<GuideLayout>
    <h1 class="f3 f2-m f1-l tc">base64 validator</h1>
    <h2 class="f4 fw4 tc">Validate a base64 encoded string</h2>
    ...
    <section class="mv5">
        ...
        <table class="collapse ba br2 b--black-10 pv2 ph3 w-100">
            ...
            <tr class="striped--light-gray">
                ...
                <td class="pv2 ph3"><code>data-fv-base64___message</code></td>
...
`} />
    ...
    <section class="mv5">
        <div class="flex">
            ...
            <NextButton target="/guide/validators/between">between validator</NextButton>
        </div>
    </section>
</GuideLayout>
