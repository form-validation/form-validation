    ...
    <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/meid/basic" on:received={receive}>
        <form id="demoForm" method="POST">
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">MEID</label>
                <div class="col-sm-5">
                    <input type="text" bind:this={inputEle} class="form-control" name="meid" />
                </div>
            </div>
        </form>
    </ReceiveMessage>
...
import meid from 'formvalidation/validators/meid';
    ...
    fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/validators/meid/basic/bootstrap',
