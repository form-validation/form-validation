        ...
        <form id="demoForm" method="post">
            <div class="cf mb2">
                <div class="fl w-100">
                    ...
                    <div class="fl w-50">
                        <input type="text" bind:this={inputEle} name="imei" class="input-reset ba b--black-20 pa2 mb2 db w-100" />
                    </div>
                </div>
            </div>
        </form>
...
import imei from 'formvalidation/validators/imei';
    ...
    fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/validators/imei/basic/tachyons',
