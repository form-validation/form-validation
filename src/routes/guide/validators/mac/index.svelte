<svelte:head>
	<title>FormValidation • mac validator</title>
</svelte:head>

<GuideLayout>
    <h1 class="f3 f2-m f1-l tc">mac validator</h1>
    <h2 class="f4 fw4 tc">Validate a MAC address</h2>
    ...
    <section class="mv5">
        ...
        <table class="collapse ba br2 b--black-10 pv2 ph3 w-100">
            ...
            <tr class="striped--light-gray">
                ...
                <td class="pv2 ph3"><code>data-fv-mac___message</code></td>
...
import mac from 'formvalidation/dist/es6/validators/mac';
...
`} />
    ...
    <RelatedValidators validators={['ip', 'uri']} />

    <section class="mv5">
        <div class="flex">
            <PrevButton target="/guide/validators/less-than">lessThan validator</PrevButton>
            <NextButton target="/guide/validators/meid">meid validator</NextButton>
        </div>
    </section>
</GuideLayout>
