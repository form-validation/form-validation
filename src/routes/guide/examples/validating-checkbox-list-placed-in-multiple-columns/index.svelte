...
`} />
        <Tip>
            ...
            <a href="/guide/plugins/bootstrap#multiple-fields-on-the-same-row" class="blue dim link">Bootstrap</a>, <a href="/guide/plugins/tachyons#multiple-fields-on-the-same-row" class="blue dim link">Tachyons</a>, .etc
        </Tip>
