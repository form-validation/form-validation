<svelte:head>
	<title>FormValidation • v0.3.0</title>
</svelte:head>

<ChangelogLayout>
    <h1 class="f3 f2-m f1-l tc">Version 0.3.0</h1>
    <h2 class="f4 fw4 tc">Released 10 March 2014</h2>
    ...
    <section class="mv5">
        ...
        <ul class="pa0 ma0 ml3 lh-copy">
            ...
            <li>Add <code>resetForm()</code> method</li>
        </ul>
    </section>
