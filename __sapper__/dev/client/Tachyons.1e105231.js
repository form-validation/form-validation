...
/* src/routes/guide/getting-started/localization/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/getting-started/localization/basic/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div3, div2, div0, t0, t1, div1, input0, t2, div7, div6, div4, t3, t4, div5, input1, t5, div11, div10, div8, t6, t7, div9, input2, t8, div15, div14, div12, t9, t10, div13, input3, t11, div19, div18, div16, t12, div17, button, t13;
	...
	return {
		...
		l: function claim(nodes) {
			...
			input2 = claim_element(div9_nodes, "INPUT", { type: true, name: true, class: true }, false);
			...
			t9 = claim_text(div12_nodes, "Date of birth");
			...
			input3 = claim_element(div13_nodes, "INPUT", { type: true, name: true, placeholder: true, class: true }, false);
		...
		h: function hydrate() {
			...
			add_location(div4, file, 12, 16, 461);
			attr(input1, "type", "text");
			input1.name = "email";
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input1, file, 14, 20, 564);
			div5.className = "fl w-50";
			add_location(div5, file, 13, 16, 522);
			div6.className = "fl w-100";
			add_location(div6, file, 11, 12, 422);
			div7.className = "cf mb2";
			add_location(div7, file, 10, 8, 389);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 20, 16, 788);
			attr(input2, "type", "password");
			input2.name = "password";
			input2.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input2, file, 22, 20, 886);
			div9.className = "fl w-40";
			add_location(div9, file, 21, 16, 844);
			div10.className = "fl w-100";
			add_location(div10, file, 19, 12, 749);
			div11.className = "cf mb2";
			add_location(div11, file, 18, 8, 716);
			div12.className = "fl w-25 pa2";
			add_location(div12, file, 28, 16, 1117);
			attr(input3, "type", "text");
			input3.name = "birthday";
			input3.placeholder = "YYYY/MM/DD";
			input3.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input3, file, 30, 20, 1220);
			div13.className = "fl w-30";
			add_location(div13, file, 29, 16, 1178);
			div14.className = "fl w-100";
			add_location(div14, file, 27, 12, 1078);
			div15.className = "cf mb2";
			add_location(div15, file, 26, 8, 1045);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 36, 16, 1472);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 38, 20, 1562);
			div17.className = "fl w-50";
			add_location(div17, file, 37, 16, 1520);
			div18.className = "fl w-100";
			add_location(div18, file, 35, 12, 1433);
			div19.className = "cf mb2";
			add_location(div19, file, 34, 8, 1400);
			form.id = "demoForm";
			form.method = "post";
