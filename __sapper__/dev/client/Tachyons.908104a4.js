...
/* src/routes/guide/examples/integrating-with-flatpickr/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/integrating-with-flatpickr/Tachyons.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			input.placeholder = "YYYY/MM/DD h:m A";
			input.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input, file, 10, 24, 508);
			div1.className = "fl w-50";
			add_location(div1, file, 9, 20, 462);
