...
/* src/routes/guide/validators/email-address/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/email-address/basic/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/email-address/basic" on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 5, 20, 271);
			attr(input, "type", "text");
			input.name = "email";
			input.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input, file, 7, 24, 382);
			div1.className = "fl w-50";
			add_location(div1, file, 6, 20, 336);
			div2.className = "fl w-100";
			add_location(div2, file, 4, 16, 228);
			div3.className = "cf mb2";
			add_location(div3, file, 3, 12, 191);
			form.id = "demoForm";
			form.method = "post";
			add_location(form, file, 2, 8, 144);
		},
