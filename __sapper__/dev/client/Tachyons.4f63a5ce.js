...
/* src/routes/guide/examples/accepting-test-credit-card-numbers/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/accepting-test-credit-card-numbers/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file, 6, 20, 244);
			div1.className = "fl w-50";
			add_location(div1, file, 5, 16, 202);
