...
/* src/routes/guide/validators/vat/basic-[country]/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/vat/basic-[country]/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/vat/basic-{item.code.toLowerCase()}" on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(div0_nodes, " VAT number");
		...
		h: function hydrate() {
			...
			add_location(div0, file, 5, 20, 287);
			attr(input, "type", "text");
			input.name = "vatNumber";
			input.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input, file, 7, 24, 412);
			div1.className = "fl w-40";
			add_location(div1, file, 6, 20, 366);
			div2.className = "fl w-100";
			add_location(div2, file, 4, 16, 244);
			div3.className = "cf mb2";
			add_location(div3, file, 3, 12, 207);
			form.id = "demoForm";
			form.method = "post";
...
function create_default_slot(ctx) {
	...
	var receivemessage = new ReceiveMessage({
		...
		sender: "/guide/validators/vat/basic-" + ctx.item.code.toLowerCase(),
	...
	return {
		...
		p: function update(changed, ctx) {
			...
			if (changed.item) receivemessage_changes.sender = "/guide/validators/vat/basic-" + ctx.item.code.toLowerCase();
