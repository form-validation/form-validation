...
/* src/routes/guide/validators/integer/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/integer/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Type an integer number");
		...
		h: function hydrate() {
			...
			input.name = "number";
			add_location(input, file, 5, 16, 247);
			div0.className = "col-sm-5";
			add_location(div0, file, 4, 12, 208);
