...
/* src/routes/guide/validators/greater-than/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/greater-than/basic/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Your age (18+ required)");
		...
		h: function hydrate() {
			...
			add_location(input, file, 6, 20, 249);
			div1.className = "fl w-25";
			add_location(div1, file, 5, 16, 207);
