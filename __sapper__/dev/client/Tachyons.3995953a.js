...
/* src/routes/guide/validators/string-length/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/string-length/basic/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div3, div2, div0, t0, t1, div1, input, t2, div7, div6, div4, t3, t4, div5, textarea;
	...
	return {
		...
		l: function claim(nodes) {
			...
			textarea = claim_element(div5_nodes, "TEXTAREA", { rows: true, name: true, class: true }, false);
		...
		h: function hydrate() {
			...
			add_location(div4, file, 12, 16, 462);
			textarea.rows = "5";
			textarea.name = "bio";
			textarea.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(textarea, file, 14, 20, 555);
			div5.className = "fl w-50";
			add_location(div5, file, 13, 16, 513);
			div6.className = "fl w-100";
			add_location(div6, file, 11, 12, 423);
			div7.className = "cf mb2";
			add_location(div7, file, 10, 8, 390);
			form.id = "demoForm";
			form.method = "post";
