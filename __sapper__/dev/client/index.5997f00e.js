...
/* src/routes/guide/validators/ean/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/ean/index.svelte";
...
// (99:12) <PrevButton target="/guide/validators/digits">
...
// (100:12) <NextButton target="/guide/validators/ein">
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/ean/basic",
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("ean validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate an ");
			a0 = element("a");
			t3 = text("EAN (International Article Number)");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-ean___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
			...
			t31 = space();
			p1 = element("p");
			t32 = text("You can click on sample to see if it's a valid or invalid EAN.");
			t33 = space();
			...
			t40 = space();
			p2 = element("p");
			t41 = text("The following snippet shows how to use the ean validator with ES6 module:");
			t42 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "ean validator");
			...
			t3 = claim_text(a0_nodes, "EAN (International Article Number)");
			...
			t22 = claim_text(code1_nodes, "data-fv-ean___message");
			...
			t32 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid EAN.");
			...
			t41 = claim_text(p2_nodes, "The following snippet shows how to use the ean validator with ES6 module:");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/International_Article_Number";
			...
			add_location(td2, file, 23, 16, 1183);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1231);
			...
			add_location(h31, file, 28, 8, 1318);
			...
			add_location(p2, file, 71, 8, 2542);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2465);
			div.className = "flex";
			add_location(div, file, 97, 8, 3201);
			section3.className = "mv5";
			add_location(section3, file, 96, 4, 3171);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • ean validator";
		},
