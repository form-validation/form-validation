...
/* src/routes/guide/validators/not-empty/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/not-empty/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "User name");
			...
			input0 = claim_element(div1_nodes, "INPUT", { type: true, name: true, class: true, required: true, "data-fv-not-empty___message": true }, false);
			...
			input1 = claim_element(div5_nodes, "INPUT", { type: true, name: true, class: true, required: true, "data-fv-not-empty___message": true }, false);
		...
		h: function hydrate() {
			...
			add_location(div4, file, 14, 16, 574);
			attr(input1, "type", "password");
			input1.name = "password";
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input1.required = true;
			input1.dataset.fvNotEmpty___message = "The password is required";
			add_location(input1, file, 16, 20, 672);
			div5.className = "fl w-50";
			add_location(div5, file, 15, 16, 630);
			div6.className = "fl w-100";
			add_location(div6, file, 13, 12, 535);
			div7.className = "cf mb2";
			add_location(div7, file, 12, 8, 502);
			form.id = "demoForm";
			form.method = "post";
