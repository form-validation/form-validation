...
/* src/routes/guide/api/enable-validator/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/api/enable-validator/index.svelte";

// (27:12) <PrevButton target="/guide/api/disable-validator">
...
// (28:12) <NextButton target="/guide/api/get-elements">
...
function create_default_slot(ctx) {
	...
	var samplecode = new SampleCode({
		props: { lang: "javascript", code: `enableValidator(field: String, validator: String): Core` },
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("enableValidator()");
			t1 = space();
			h2 = element("h2");
			t2 = text("Enable particular validator for given field.");
			t3 = space();
			...
			code1 = element("code");
			t13 = text("validator");
			t14 = text(" — The validator name. If it isn't specified, all validators will be enabled");
			t15 = space();
			examples.$$.fragment.c();
			t16 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "enableValidator()");
			...
			t2 = claim_text(h2_nodes, "Enable particular validator for given field.");
			...
			t14 = claim_text(li1_nodes, " — The validator name. If it isn't specified, all validators will be enabled");
		...
		h: function hydrate() {
			...
			div0.className = "mb3";
			add_location(div0, file, 9, 8, 268);
			add_location(sup0, file, 12, 29, 440);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 419);
			add_location(code0, file, 14, 16, 540);
			add_location(sup1, file, 14, 35, 559);
			add_location(li0, file, 14, 12, 536);
			add_location(code1, file, 15, 16, 610);
			add_location(li1, file, 15, 12, 606);
			ul.className = "ma0 pl3 lh-copy";
			add_location(ul, file, 13, 8, 495);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 238);
			div1.className = "flex";
			add_location(div1, file, 25, 8, 907);
			section1.className = "mv5";
			add_location(section1, file, 24, 4, 877);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • enableValidator() method";
		},
