...
/* src/routes/guide/plugins/mini/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/mini/index.svelte";
...
// (111:12) <PrevButton target="/guide/plugins/milligram">
...
// (112:12) <NextButton target="/guide/plugins/mui">
...
function create_default_slot(ctx) {
	var h1, t0, t1, h2, t2, a, t3, t4, t5, section0, t6, p0, t7, t8, t9, p1, t10, code0, t11, t12, t13, p2, t14, t15, section1, t16, t17, section2, t18, p3, t19, code1, t20, t21, code2, t22, t23, t24, div0, t25, t26, section3, t27, p4, t28, t29, p5, t30, code3, t31, t32, code4, t33, t34, code5, t35, t36, code6, t37, t38, code7, t39, t40, code8, t41, t42, code9, t43, t44, code10, t45, t46, t47, p6, t48, code11, t49, t50, t51, div1, t52, t53, section4, t54, ul, li, t55, t56, section5, div2, t57, current;
...
` },
	...
	var demo1 = new Demo({
		props: {
		prefix: "/guide/plugins/mini/stacked-form",
		frameworks: ['mini']
	},
		$$inline: true
	});
...
` },
	...
	var demo2 = new Demo({
		props: {
		prefix: "/guide/plugins/mini/multiple-fields",
		frameworks: ['mini']
	},
		$$inline: true
	});
	...
	return {
		c: function create() {
			...
			a = element("a");
			t3 = text("mini.css");
			t4 = text(" framework. Support mini.css v3.0.1");
			t5 = space();
			section0 = element("section");
			heading0.$$.fragment.c();
			t6 = space();
			p0 = element("p");
			t7 = text("The following piece of code is the starting point to validate the form made in mini.css:");
			t8 = space();
			...
			t13 = space();
			p2 = element("p");
			t14 = text("The next sections list out some examples of various forms made with mini.css.");
			t15 = space();
			...
			t29 = space();
			p5 = element("p");
			t30 = text("By default, the Mini plugin will look for the ");
			code3 = element("code");
			t31 = text(".row");
			...
			ul = element("ul");
			li = element("li");
			t55 = text("v1.2.0: First release. It means that the Mini plugin requires FormValidation v1.2.0 or newer.");
			t56 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Mini plugin");
			...
			t3 = claim_text(a_nodes, "mini.css");
			a_nodes.forEach(detach);
			t4 = claim_text(h2_nodes, " framework. Support mini.css v3.0.1");
			...
			t7 = claim_text(p0_nodes, "The following piece of code is the starting point to validate the form made in mini.css:");
			...
			t14 = claim_text(p2_nodes, "The next sections list out some examples of various forms made with mini.css.");
			...
			t28 = claim_text(p4_nodes, "In order to add the correct class for error message and the field element when it is a valid or invalid, we need to specify the CSS selector of the field container.");
			...
			t30 = claim_text(p5_nodes, "By default, the Mini plugin will look for the ");

			code3 = claim_element(p5_nodes, "CODE", {}, false);
			var code3_nodes = children(code3);

			t31 = claim_text(code3_nodes, ".row");
			code3_nodes.forEach(detach);
			t32 = claim_text(p5_nodes, " element. In the following example, the ");
			...
			t37 = claim_text(code6_nodes, ".col-sm-4");
			code6_nodes.forEach(detach);
			t38 = claim_text(p5_nodes, " containers. Meanwhile, the ");
			...
			t44 = claim_text(p5_nodes, " fields can be found inside the ");

			code10 = claim_element(p5_nodes, "CODE", {}, false);
			var code10_nodes = children(code10);

			t45 = claim_text(code10_nodes, ".col-sm-3");
			code10_nodes.forEach(detach);
			t46 = claim_text(p5_nodes, " containers.");
			...
			t50 = claim_text(p6_nodes, " option will be used to help the plugin determine the field containers as following:");
			...
			t55 = claim_text(li_nodes, "v1.2.0: First release. It means that the Mini plugin requires FormValidation v1.2.0 or newer.");
		...
		h: function hydrate() {
			...
			add_location(a, file, 6, 49, 187);
			h2.className = "f4 fw4 tc lh-copy";
			add_location(h2, file, 6, 4, 142);
			p0.className = "lh-copy";
			add_location(p0, file, 10, 8, 360);
			add_location(code0, file, 45, 109, 1585);
			p1.className = "lh-copy";
			add_location(p1, file, 45, 8, 1484);
			p2.className = "lh-copy";
			add_location(p2, file, 46, 8, 1712);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 297);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1833);
			add_location(code1, file, 56, 47, 2111);
			add_location(code2, file, 56, 89, 2153);
			p3.className = "lh-copy";
			add_location(p3, file, 56, 8, 2072);
			div0.className = "mb4";
			add_location(div0, file, 57, 8, 2200);
			section2.className = "mv5";
			add_location(section2, file, 54, 4, 2002);
			p4.className = "lh-copy";
			add_location(p4, file, 70, 8, 2552);
			add_location(code3, file, 71, 73, 2813);
			add_location(code4, file, 71, 130, 2870);
			add_location(code5, file, 71, 157, 2897);
			add_location(code6, file, 72, 37, 2956);
			add_location(code7, file, 72, 87, 3006);
			add_location(code8, file, 72, 106, 3025);
			add_location(code9, file, 72, 129, 3048);
			add_location(code10, file, 72, 181, 3100);
			p5.className = "lh-copy";
			add_location(p5, file, 71, 8, 2748);
			add_location(code11, file, 74, 31, 3179);
			p6.className = "lh-copy";
			add_location(p6, file, 74, 8, 3156);
			div1.className = "mb4";
			add_location(div1, file, 75, 8, 3300);
			section3.className = "mv5";
			add_location(section3, file, 68, 4, 2463);
			add_location(li, file, 104, 12, 4089);
			ul.className = "pa0 ma0 ml3 lh-copy";
			add_location(ul, file, 103, 8, 4044);
			section4.className = "mv5";
			add_location(section4, file, 101, 4, 3977);
			div2.className = "flex";
			add_location(div2, file, 109, 8, 4256);
			section5.className = "mv5";
			add_location(section5, file, 108, 4, 4226);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Mini plugin";
		},
