...
/* src/routes/guide/examples/supporting-custom-date-format/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/supporting-custom-date-format/index.svelte";
...
function create_default_slot(ctx) {
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/examples/supporting-custom-date-format",
		frameworks: ['tachyons']
	},
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("Supporting custom date format");
			t1 = space();
			section = element("section");
			p = element("p");
			t2 = text("This example illustrates the ability of validating date in custom format by using the ");
			a0 = element("a");
			t3 = text("callback");
			t4 = text(" validator and ");
			a1 = element("a");
			t5 = text("momentjs");
			t6 = text(" to parse/validate.");
			t7 = space();
			demo.$$.fragment.c();
			t8 = space();
			examples.$$.fragment.c();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Supporting custom date format");
			...
			t2 = claim_text(p_nodes, "This example illustrates the ability of validating date in custom format by using the ");
			...
			t4 = claim_text(p_nodes, " validator and ");

			a1 = claim_element(p_nodes, "A", { href: true, class: true }, false);
			var a1_nodes = children(a1);

			t5 = claim_text(a1_nodes, "momentjs");
			a1_nodes.forEach(detach);
			t6 = claim_text(p_nodes, " to parse/validate.");
		...
		h: function hydrate() {
			...
			add_location(a0, file, 8, 113, 313);
			a1.href = "http://momentjs.com";
			a1.className = "blue dim link";
			add_location(a1, file, 8, 199, 399);
			p.className = "lh-copy";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Supporting custom date format";
		},
