...
/* src/routes/guide/examples/showing-messages-in-custom-area/container/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/showing-messages-in-custom-area/container/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div3, div2, div0, t0, t1, div1, input0, t2, div7, div6, div4, t3, t4, div5, input1, t5, div15, div14, div8, t6, t7, div13, div9, label0, input2, t8, t9, div10, label1, input3, t10, t11, div11, label2, input4, t12, t13, div12, label3, input5, t14, t15, div21, div20, div16, t16, t17, div19, div17, label4, input6, t18, t19, div18, label5, input7, t20, t21, div25, div24, div22, t22, div23, t23, div29, div28, div26, t24, div27, button, t25;
	...
	return {
		...
		l: function claim(nodes) {
			...
			div23 = claim_element(div24_nodes, "DIV", { class: true, id: true }, false);
			...
			t25 = claim_text(button_nodes, "Add product");
		...
		h: function hydrate() {
			...
			add_location(div22, file, 57, 16, 2221);
			div23.className = "fl w-75";
			div23.id = "messages";
			add_location(div23, file, 58, 16, 2269);
			div24.className = "fl w-100";
			add_location(div24, file, 56, 12, 2182);
			div25.className = "cf mb2";
			add_location(div25, file, 55, 8, 2149);
			div26.className = "fl w-25 pa2";
			add_location(div26, file, 64, 16, 2426);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 66, 20, 2516);
			div27.className = "fl w-50";
			add_location(div27, file, 65, 16, 2474);
			div28.className = "fl w-100";
			add_location(div28, file, 63, 12, 2387);
			div29.className = "cf mb2";
			add_location(div29, file, 62, 8, 2354);
			form.id = "demoForm";
			form.method = "POST";
