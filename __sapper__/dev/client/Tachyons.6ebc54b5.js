...
/* src/routes/guide/examples/using-material-design-icons/material-design/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/using-material-design-icons/material-design/Tachyons.svelte";

// (17:4) <ResourceLoader urls={['https://fonts.googleapis.com/icon?family=Material+Icons']} onLoaded={onLoaded}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 20, 20, 557);
			attr(input0, "type", "text");
			input0.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input0.name = "name";
			add_location(input0, file, 22, 24, 667);
			div1.className = "fl w-75";
			add_location(div1, file, 21, 20, 621);
			div2.className = "fl w-100";
			add_location(div2, file, 19, 16, 514);
			div3.className = "cf mb2";
			add_location(div3, file, 18, 12, 477);
			div4.className = "fl w-25 pa2";
			add_location(div4, file, 29, 20, 923);
			attr(input1, "type", "text");
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input1.name = "price";
			add_location(input1, file, 31, 24, 1030);
			div5.className = "fl w-75";
			add_location(div5, file, 30, 20, 984);
			div6.className = "fl w-100";
			add_location(div6, file, 28, 16, 880);
			div7.className = "cf mb2";
			add_location(div7, file, 27, 12, 843);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 38, 20, 1287);
			attr(input2, "type", "checkbox");
			input2.name = "size[]";
			input2.value = "s";
			add_location(input2, file, 41, 35, 1442);
			add_location(label0, file, 41, 28, 1435);
			div9.className = "mb2";
			add_location(div9, file, 40, 24, 1389);
			attr(input3, "type", "checkbox");
			input3.name = "size[]";
			input3.value = "m";
			add_location(input3, file, 44, 35, 1610);
			add_location(label1, file, 44, 28, 1603);
			div10.className = "mb2";
			add_location(div10, file, 43, 24, 1557);
			attr(input4, "type", "checkbox");
			input4.name = "size[]";
			input4.value = "l";
			add_location(input4, file, 47, 35, 1778);
			add_location(label2, file, 47, 28, 1771);
			div11.className = "mb2";
			add_location(div11, file, 46, 24, 1725);
			attr(input5, "type", "checkbox");
			input5.name = "size[]";
			input5.value = "xl";
			add_location(input5, file, 50, 35, 1946);
			add_location(label3, file, 50, 28, 1939);
			div12.className = "mb2";
			add_location(div12, file, 49, 24, 1893);
			div13.className = "fl w-75";
			add_location(div13, file, 39, 20, 1343);
			div14.className = "fl w-100";
			add_location(div14, file, 37, 16, 1244);
			div15.className = "cf mb2";
			add_location(div15, file, 36, 12, 1207);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 58, 20, 2209);
			attr(input6, "type", "radio");
			input6.name = "availability";
			input6.value = "yes";
			add_location(input6, file, 61, 35, 2378);
			add_location(label4, file, 61, 28, 2371);
			div17.className = "mb2";
			add_location(div17, file, 60, 24, 2325);
			attr(input7, "type", "radio");
			input7.name = "availability";
			input7.value = "no";
			add_location(input7, file, 64, 35, 2553);
			add_location(label5, file, 64, 28, 2546);
			div18.className = "mb2";
			add_location(div18, file, 63, 24, 2500);
			div19.className = "fl w-75";
			add_location(div19, file, 59, 20, 2279);
			div20.className = "fl w-100";
			add_location(div20, file, 57, 16, 2166);
			div21.className = "cf mb2";
			add_location(div21, file, 56, 12, 2129);
			div22.className = "fl w-25 pa2";
			add_location(div22, file, 72, 20, 2811);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 75, 24, 3004);
			div23.className = "fl w-50";
			add_location(div23, file, 73, 20, 2863);
			div24.className = "fl w-100";
			add_location(div24, file, 71, 16, 2768);
			div25.className = "cf mb2";
			add_location(div25, file, 70, 12, 2731);
			form.id = "demoForm";
			form.method = "POST";
			add_location(form, file, 17, 8, 430);
		},
