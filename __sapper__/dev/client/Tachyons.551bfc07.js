...
/* src/routes/guide/examples/validating-an-avatar-url/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/validating-an-avatar-url/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Avatar URL");
		...
		h: function hydrate() {
			...
			add_location(input, file, 6, 20, 236);
