...
/* src/routes/guide/validators/issn/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/issn/index.svelte";
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(tr, file, 59, 12, 2198);
		},
...
// (99:12) <PrevButton target="/guide/validators/ismn">
...
// (100:12) <NextButton target="/guide/validators/less-than">
function create_default_slot_1(ctx) {
	var t;

	return {
		c: function create() {
			t = text("lessThan validator");
		},

		l: function claim(nodes) {
			t = claim_text(nodes, "lessThan validator");
		},
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/issn/basic",
...
` },
	...
	var nextbutton = new NextButton({
		props: {
		target: "/guide/validators/less-than",
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("issn validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate an ");
			a0 = element("a");
			t3 = text("ISSN (International Standard Serial Number)");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-issn___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
			...
			t31 = space();
			p1 = element("p");
			t32 = text("You can click on sample to see if it's a valid or invalid ISSN.");
			t33 = space();
			...
			t40 = space();
			p2 = element("p");
			t41 = text("The following snippet shows how to use the issn validator with ES6 module:");
			t42 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "issn validator");
			...
			t3 = claim_text(a0_nodes, "ISSN (International Standard Serial Number)");
			...
			t22 = claim_text(code1_nodes, "data-fv-issn___message");
			...
			t32 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid ISSN.");
			...
			t41 = claim_text(p2_nodes, "The following snippet shows how to use the issn validator with ES6 module:");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/International_Standard_Serial_Number";
			a0.className = "blue dim link";
			add_location(a0, file, 6, 38, 182);
			h2.className = "f4 fw4 tc";
			add_location(h2, file, 6, 4, 148);
			add_location(h30, file, 11, 8, 405);
			a1.href = "/guide/plugins/declarative";
			a1.className = "blue dim link";
			add_location(a1, file, 12, 95, 531);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 444);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 744);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 804);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 874);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 934);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 695);
			add_location(code0, file, 21, 36, 1084);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 1064);
			add_location(code1, file, 22, 36, 1146);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1126);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1203);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1251);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 1015);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table0, file, 13, 8, 625);
			add_location(h31, file, 28, 8, 1338);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 339);
			p1.className = "lh-copy";
			add_location(p1, file, 52, 8, 1800);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 55, 16, 2018);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 56, 16, 2080);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 54, 12, 1969);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 53, 8, 1895);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1728);
			p2.className = "lh-copy";
			add_location(p2, file, 71, 8, 2563);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2486);
			div.className = "flex";
			add_location(div, file, 97, 8, 3225);
			section3.className = "mv5";
			add_location(section3, file, 96, 4, 3195);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • issn validator";
		},
