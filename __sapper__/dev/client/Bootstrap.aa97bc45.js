...
/* src/routes/guide/validators/email-address/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/email-address/basic/Bootstrap.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Email address");
		...
		h: function hydrate() {
			...
			add_location(label, file, 4, 16, 257);
			attr(input, "type", "text");
			input.className = "form-control";
			input.name = "email";
			add_location(input, file, 6, 20, 377);
			div0.className = "col-sm-6";
			add_location(div0, file, 5, 16, 334);
			div1.className = "form-group row";
			add_location(div1, file, 3, 12, 212);
			form.id = "demoForm";
			form.method = "POST";
			add_location(form, file, 2, 8, 165);
		},
