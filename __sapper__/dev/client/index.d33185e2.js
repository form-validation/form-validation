...
/* src/routes/guide/validators/siren/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/siren/index.svelte";
...
// (54:12) <PrevButton target="/guide/validators/sedol">
...
// (55:12) <NextButton target="/guide/validators/siret">
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("siren validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a ");
			a0 = element("a");
			t3 = text("Siren number");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-siren___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "siren validator");
			...
			t3 = claim_text(a0_nodes, "Siren number");
			...
			t22 = claim_text(code1_nodes, "data-fv-siren___message");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/SIREN_code";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • siren validator";
		},
