...
/* src/routes/guide/examples/using-html-5-inputs-and-attributes/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/using-html-5-inputs-and-attributes/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div3, div2, div0, t0, t1, div1, input0, t2, div7, div6, div4, t3, t4, div5, input1, t5, div11, div10, div8, t6, t7, div9, input2, t8, div15, div14, div12, t9, t10, div13, input3, t11, div19, div18, div16, t12, t13, div17, input4, t14, div23, div22, div20, t15, div21, button, t16;
	...
	return {
		...
		l: function claim(nodes) {
			...
			input0 = claim_element(div1_nodes, "INPUT", { type: true, class: true, name: true, required: true, "data-fv-not-empty___message": true, pattern: true, "data-fv-regexp___message": true }, false);
			...
			input1 = claim_element(div5_nodes, "INPUT", { class: true, name: true, type: true, "data-fv-email-address___message": true, required: true, "data-fv-not-empty___message": true }, false);
			...
			t6 = claim_text(div8_nodes, "Website");
			...
			input2 = claim_element(div9_nodes, "INPUT", { class: true, name: true, type: true, "data-fv-uri___message": true, required: true, "data-fv-not-empty___message": true }, false);
			...
			t9 = claim_text(div12_nodes, "Fav color");
			...
			input3 = claim_element(div13_nodes, "INPUT", { class: true, name: true, type: true, "data-fv-color___message": true, required: true, "data-fv-not-empty___message": true }, false);
			...
			t12 = claim_text(div16_nodes, "Age");
			div16_nodes.forEach(detach);
			t13 = claim_text(div18_nodes, "\n                ");

			div17 = claim_element(div18_nodes, "DIV", { class: true }, false);
			var div17_nodes = children(div17);

			input4 = claim_element(div17_nodes, "INPUT", { type: true, class: true, name: true, min: true, "data-fv-greater-than___inclusive": true, "data-fv-greater-than___message": true, max: true, "data-fv-less-than___inclusive": true, "data-fv-less-than___message": true, required: true, "data-fv-not-empty___message": true }, false);
			...
			t16 = claim_text(button_nodes, "Submit");
		...
		h: function hydrate() {
			...
			input0.dataset.fvNotEmpty___message = "The username is required";
			input0.pattern = "^[a-zA-Z0-9]+$";
			input0.dataset.fvRegexp___message = "The username can only consist of alphabetical, number";
			...
			add_location(div4, file, 18, 16, 757);
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input1.name = "email";
			attr(input1, "type", "email");
			input1.dataset.fvEmailAddress___message = "The input is not a valid email address";
			input1.required = true;
			input1.dataset.fvNotEmpty___message = "The email is required";
			add_location(input1, file, 20, 20, 860);
			div5.className = "fl w-40";
			add_location(div5, file, 19, 16, 818);
			div6.className = "fl w-100";
			add_location(div6, file, 17, 12, 718);
			div7.className = "cf mb2";
			add_location(div7, file, 16, 8, 685);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 32, 16, 1345);
			input2.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input2.name = "website";
			attr(input2, "type", "url");
			input2.dataset.fvUri___message = "The input is not a valid website address";
			input2.required = true;
			input2.dataset.fvNotEmpty___message = "The website is required";
			add_location(input2, file, 34, 20, 1442);
			div9.className = "fl w-40";
			add_location(div9, file, 33, 16, 1400);
			div10.className = "fl w-100";
			add_location(div10, file, 31, 12, 1306);
			div11.className = "cf mb2";
			add_location(div11, file, 30, 8, 1273);
			div12.className = "fl w-25 pa2";
			add_location(div12, file, 46, 16, 1917);
			input3.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input3.name = "color";
			attr(input3, "type", "color");
			input3.dataset.fvColor___message = "The input is not a valid color code";
			input3.required = true;
			input3.dataset.fvNotEmpty___message = "The color is required";
			add_location(input3, file, 48, 20, 2016);
			div13.className = "fl w-40";
			add_location(div13, file, 47, 16, 1974);
			div14.className = "fl w-100";
			add_location(div14, file, 45, 12, 1878);
			div15.className = "cf mb2";
			add_location(div15, file, 44, 8, 1845);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 60, 16, 2490);
			attr(input4, "type", "text");
			input4.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input4.name = "age";
			input4.min = "10";
			input4.dataset.fvGreaterThan___inclusive = "true";
			input4.dataset.fvGreaterThan___message = "The input must be greater than or equal to 10";
			input4.max = "100";
			input4.dataset.fvLessThan___inclusive = "false";
			input4.dataset.fvLessThan___message = "The input must be less than 100";
			input4.required = true;
			input4.dataset.fvNotEmpty___message = "The age is required";
			add_location(input4, file, 62, 20, 2583);
			div17.className = "fl w-20";
			add_location(div17, file, 61, 16, 2541);
			div18.className = "fl w-100";
			add_location(div18, file, 59, 12, 2451);
			div19.className = "cf mb2";
			add_location(div19, file, 58, 8, 2418);
			div20.className = "fl w-25 pa2";
			add_location(div20, file, 79, 16, 3329);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 81, 20, 3419);
			div21.className = "fl w-50";
			add_location(div21, file, 80, 16, 3377);
			div22.className = "fl w-100";
			add_location(div22, file, 78, 12, 3290);
			div23.className = "cf mb2";
			add_location(div23, file, 77, 8, 3257);
			form.id = "demoForm";
			form.method = "POST";
    ...
    const fv = formValidation(document.getElementById('demoForm'), {
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/examples/using-html-5-inputs-and-attributes/tachyons',
