...
/* src/routes/guide/examples/validating-social-account-url/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/validating-social-account-url/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Your Facebook URL");
		...
		h: function hydrate() {
			...
			add_location(input, file, 6, 20, 243);
			div1.className = "fl w-50";
			add_location(div1, file, 5, 16, 201);
