...
/* src/routes/guide/validators/date/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/date/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Birthday");
			...
			input = claim_element(div0_nodes, "INPUT", { type: true, class: true, name: true, placeholder: true }, false);
		...
		h: function hydrate() {
			...
			add_location(input, file, 5, 16, 233);
