...
/* src/routes/guide/validators/greater-than/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/greater-than/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Your age (18+ required)");
		...
		h: function hydrate() {
			...
			input.name = "age";
			add_location(input, file, 5, 16, 248);
			div0.className = "col-sm-3";
			add_location(div0, file, 4, 12, 209);
