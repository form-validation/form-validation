...
/* src/routes/guide/getting-started/usage/frameworks/Materialize.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/getting-started/usage/frameworks/Materialize.svelte";

// (1:0) <MaterializeLayout onLoaded={onLoaded}>
function create_default_slot(ctx) {
	var form, div1, div0, input0, t0, label0, t1, t2, div3, div2, input1, t3, label1, t4, t5, div5, div4, button, t6;
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(label1, file, 12, 16, 426);
			...
			add_location(button, file, 18, 16, 561);
			div4.className = "col s12";
			add_location(div4, file, 17, 12, 523);
			div5.className = "row";
			add_location(div5, file, 16, 8, 493);
			form.id = "demoForm";
			form.method = "post";
