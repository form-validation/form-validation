...
/* src/routes/guide/events/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/events/index.svelte";

// (57:12) <PrevButton target="/guide/api">
...
// (58:12) <NextButton target="/guide/events/core.element.notvalidated">
...
` },
	...
	return {
		c: function create() {
			...
			t1 = space();
			h2 = element("h2");
			t2 = text("A collection of events that you can hook on");
			t3 = space();
			...
			t6 = text(", you can listen on events provided by ");
			code1 = element("code");
			t7 = text("formValidation");
			t8 = text(" or its plugins.");
			t9 = space();
			h30 = element("h3");
			...
			t15 = space();
			p1 = element("p");
			t16 = text("The next sections list all of events provided by library.");
			t17 = space();
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h2_nodes, "A collection of events that you can hook on");
			...
			t6 = claim_text(p0_nodes, ", you can listen on events provided by ");
			...
			t8 = claim_text(p0_nodes, " or its plugins.");
			...
			t16 = claim_text(p1_nodes, "The next sections list all of events provided by library.");
		...
		h: function hydrate() {
			...
			add_location(h1, file, 5, 4, 88);
			h2.className = "f4 fw4 tc";
			add_location(h2, file, 6, 4, 132);
			add_location(code0, file, 9, 60, 290);
			add_location(code1, file, 9, 143, 373);
			p0.className = "lh-copy";
			add_location(p0, file, 9, 8, 238);
			add_location(h30, file, 11, 8, 430);
			add_location(h31, file, 32, 8, 907);
			p1.className = "lh-copy";
			add_location(p1, file, 51, 8, 1354);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 208);
			div.className = "flex";
			add_location(div, file, 55, 8, 1485);
			section1.className = "mv5";
			add_location(section1, file, 54, 4, 1455);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Events";
		},
