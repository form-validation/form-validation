...
/* src/components/PrevButton.svelte generated by Svelte v3.4.2 */

const file = "src/components/PrevButton.svelte";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			a.href = ctx.target;
			a.className = "f3 pointer blue dim link pa2";
...
class PrevButton extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get target() {
		throw new Error("<PrevButton>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set target(value) {
		throw new Error("<PrevButton>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { PrevButton as a };
