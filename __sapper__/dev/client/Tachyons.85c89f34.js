...
/* src/routes/guide/plugins/tachyons/horizontal-form/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/tachyons/horizontal-form/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(button, file, 59, 20, 2367);
    ...
    const fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/plugins/tachyons/horizontal-form/tachyons',
