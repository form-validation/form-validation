...
/* src/routes/guide/plugins/field-status/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/field-status/index.svelte";
...
// (64:12) <PrevButton target="/guide/plugins/excluded">
...
// (65:12) <NextButton target="/guide/plugins/foundation">
...
function create_default_slot(ctx) {
	var h1, t0, t1, h2, t2, t3, section0, t4, p0, t5, t6, t7, p1, t8, code, t9, t10, t11, section1, t12, ul, li, t13, t14, t15, section2, div, t16, current;
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("FieldStatus plugin");
			t1 = space();
			h2 = element("h2");
			t2 = text("Track the field status, and allow to perform an action when a field status is changed");
			t3 = space();
			section0 = element("section");
			heading0.$$.fragment.c();
			t4 = space();
			p0 = element("p");
			t5 = text("The following piece of code is the starting point to use the FieldStatus plugin:");
			t6 = space();
			...
			ul = element("ul");
			li = element("li");
			t13 = text("v1.5.0: First release. It means that the FieldStatus plugin requires FormValidation v1.5.0 or newer.");
			t14 = space();
			examples.$$.fragment.c();
			t15 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "FieldStatus plugin");
			...
			t2 = claim_text(h2_nodes, "Track the field status, and allow to perform an action when a field status is changed");
			...
			t5 = claim_text(p0_nodes, "The following piece of code is the starting point to use the FieldStatus plugin:");
			...
			t13 = claim_text(li_nodes, "v1.5.0: First release. It means that the FieldStatus plugin requires FormValidation v1.5.0 or newer.");
		...
		h: function hydrate() {
			...
			add_location(p0, file, 10, 8, 337);
			add_location(code, file, 47, 109, 1549);
			p1.className = "lh-copy";
			add_location(p1, file, 47, 8, 1448);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 274);
			add_location(li, file, 53, 12, 1804);
			ul.className = "pa0 ma0 ml3 lh-copy";
			add_location(ul, file, 52, 8, 1759);
			section1.className = "mv5";
			add_location(section1, file, 50, 4, 1692);
			div.className = "flex";
			add_location(div, file, 62, 8, 2080);
			section2.className = "mv5";
			add_location(section2, file, 61, 4, 2050);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • FieldStatus plugin";
		},
