...
/* src/routes/guide/validators/string-length/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/string-length/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			input = claim_element(div1_nodes, "INPUT", { type: true, name: true, class: true, maxlength: true, minlength: true, "data-fv-string-length___message": true }, false);
		...
		h: function hydrate() {
			...
			input.maxLength = "40";
			attr(input, "minlength", "10");
			input.dataset.fvStringLength___message = "The full name must be more than 10 and less than 40 characters";
			add_location(input, file, 6, 20, 235);
