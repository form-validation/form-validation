...
/* src/routes/guide/examples/supporting-custom-date-format/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/supporting-custom-date-format/Tachyons.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		c: function create() {
			...
			div2 = element("div");
			div0 = element("div");
			t0 = text("What's US independence day?");
			t1 = space();
			div1 = element("div");
			input = element("input");
			this.h();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "What's US independence day?");
		...
		h: function hydrate() {
			...
			input.name = "independenceDay";
			input.placeholder = "MMM D";
			input.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input, file, 7, 24, 399);
			div1.className = "fl w-50";
			add_location(div1, file, 6, 20, 353);
