...
/* src/routes/guide/api/add-field/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/api/add-field/index.svelte";

// (26:12) <PrevButton target="/guide/api">
...
// (27:12) <NextButton target="/guide/api/deregister-filter">
...
function create_default_slot(ctx) {
	...
	var samplecode = new SampleCode({
		props: { lang: "javascript", code: `addField(field: String, options: Object): Core` },
		$$inline: true
	});
	...
	return {
		c: function create() {
			...
			code1 = element("code");
			t13 = text("options");
			t14 = text(" — The field options. The options will be merged with the original validator rules if the field is already defined");
			t15 = space();
			examples.$$.fragment.c();
			t16 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "addField()");
			...
			t2 = claim_text(h2_nodes, "Add a field");
			...
			t13 = claim_text(code1_nodes, "options");
			code1_nodes.forEach(detach);
			t14 = claim_text(li1_nodes, " — The field options. The options will be merged with the original validator rules if the field is already defined");
		...
		h: function hydrate() {
			...
			div0.className = "mb3";
			add_location(div0, file, 9, 8, 221);
			add_location(sup0, file, 12, 29, 384);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 363);
			add_location(code0, file, 14, 16, 484);
			add_location(sup1, file, 14, 35, 503);
			add_location(li0, file, 14, 12, 480);
			add_location(code1, file, 15, 16, 554);
			add_location(li1, file, 15, 12, 550);
			ul.className = "ma0 pl3 lh-copy";
			add_location(ul, file, 13, 8, 439);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 191);
			div1.className = "flex";
			add_location(div1, file, 24, 8, 827);
			section1.className = "mv5";
			add_location(section1, file, 23, 4, 797);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • addField() method";
		},
