...
/* src/routes/guide/examples/showing-only-one-message-each-time/tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/showing-only-one-message-each-time/tachyons.svelte";
