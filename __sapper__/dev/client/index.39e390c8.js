...
/* src/routes/guide/validators/sedol/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/sedol/index.svelte";
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(tr, file, 59, 12, 2172);
		},
...
// (99:12) <PrevButton target="/guide/validators/rtn">
...
// (100:12) <NextButton target="/guide/validators/siren">
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/sedol/basic",
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("sedol validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a ");
			a0 = element("a");
			t3 = text("SEDOL (Stock Exchange Daily Official List)");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-sedol___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
			...
			t31 = space();
			p1 = element("p");
			t32 = text("You can click on sample to see if it's a valid or invalid SEDOL.");
			t33 = space();
			...
			t40 = space();
			p2 = element("p");
			t41 = text("The following snippet shows how to use the sedol validator with ES6 module:");
			t42 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "sedol validator");
			...
			t3 = claim_text(a0_nodes, "SEDOL (Stock Exchange Daily Official List)");
			...
			t22 = claim_text(code1_nodes, "data-fv-sedol___message");
			...
			t32 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid SEDOL.");
			...
			t41 = claim_text(p2_nodes, "The following snippet shows how to use the sedol validator with ES6 module:");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/SEDOL";
			a0.className = "blue dim link";
			add_location(a0, file, 6, 37, 183);
			h2.className = "f4 fw4 tc";
			add_location(h2, file, 6, 4, 150);
			add_location(h30, file, 11, 8, 374);
			a1.href = "/guide/plugins/declarative";
			a1.className = "blue dim link";
			add_location(a1, file, 12, 95, 500);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 413);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 713);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 773);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 843);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 903);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 664);
			add_location(code0, file, 21, 36, 1053);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 1033);
			add_location(code1, file, 22, 36, 1115);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1095);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1173);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1221);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 984);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table0, file, 13, 8, 594);
			add_location(h31, file, 28, 8, 1308);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 308);
			p1.className = "lh-copy";
			add_location(p1, file, 52, 8, 1773);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 55, 16, 1992);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 56, 16, 2054);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 54, 12, 1943);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 53, 8, 1869);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1701);
			p2.className = "lh-copy";
			add_location(p2, file, 71, 8, 2539);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2462);
			div.className = "flex";
			add_location(div, file, 97, 8, 3206);
			section3.className = "mv5";
			add_location(section3, file, 96, 4, 3176);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • sedol validator";
		},
