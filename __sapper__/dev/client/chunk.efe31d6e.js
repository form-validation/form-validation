...
class Turret extends Framework {
    constructor(opts) {
        super(Object.assign({}, {
...
/* src/components/demo/TurretLayout.svelte generated by Svelte v3.4.2 */

// (17:0) <ResourceLoader useExternalFramework="true" urls={['https://cdnjs.cloudflare.com/ajax/libs/bigfishtv-turret/5.1.3/turretcss.min.css']} onLoaded={onLoaded}>
...
class TurretLayout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<TurretLayout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<TurretLayout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { TurretLayout as a, Turret as b };
