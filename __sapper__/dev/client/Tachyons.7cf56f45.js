...
/* src/routes/guide/validators/between/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/between/basic/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Latitude");
			...
			t3 = claim_text(div4_nodes, "Longitude");
		...
		h: function hydrate() {
			...
			add_location(input1, file, 14, 20, 560);
			div5.className = "fl w-50";
			add_location(div5, file, 13, 16, 518);
