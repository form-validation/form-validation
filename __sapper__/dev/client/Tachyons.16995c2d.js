...
/* src/routes/guide/examples/pending-validation-for-a-given-number-of-seconds/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/pending-validation-for-a-given-number-of-seconds/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Email");
			...
			t3 = claim_text(div4_nodes, "Username");
		...
		h: function hydrate() {
			...
			add_location(input1, file, 15, 20, 554);
			div5.className = "fl w-40";
			add_location(div5, file, 14, 16, 512);
			...
			add_location(div8, file, 22, 16, 786);
			attr(input2, "type", "password");
			input2.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input2.name = "password";
			add_location(input2, file, 24, 20, 884);
			div9.className = "fl w-40";
			add_location(div9, file, 23, 16, 842);
			div10.className = "fl w-100";
			add_location(div10, file, 21, 12, 747);
			div11.className = "cf mb2";
			add_location(div11, file, 20, 8, 714);
			div12.className = "fl w-25 pa2";
			add_location(div12, file, 31, 16, 1116);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 33, 20, 1206);
			div13.className = "fl w-50";
			add_location(div13, file, 32, 16, 1164);
			div14.className = "fl w-100";
			add_location(div14, file, 30, 12, 1077);
			div15.className = "cf mb2";
			add_location(div15, file, 29, 8, 1044);
			form.id = "demoForm";
			form.method = "POST";
