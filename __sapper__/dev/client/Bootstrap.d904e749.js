...
import { a as cusip } from './chunk.20fd6b84.js';
...
/* src/routes/guide/validators/cusip/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/cusip/basic/Bootstrap.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender='/guide/validators/cusip/basic' on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "CUSIP");
