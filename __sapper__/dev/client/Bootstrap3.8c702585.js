...
/* src/routes/guide/plugins/bootstrap3/without-label-form/Bootstrap3.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/bootstrap3/without-label-form/Bootstrap3.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file, 3, 12, 123);
			...
			add_location(input1, file, 7, 12, 270);
			div1.className = "form-group";
			add_location(div1, file, 6, 8, 233);
			button.type = "submit";
			button.className = "btn btn-primary";
			add_location(button, file, 11, 8, 463);
			form.id = "demoForm";
			form.method = "POST";
