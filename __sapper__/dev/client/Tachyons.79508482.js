...
/* src/routes/guide/validators/uri/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/uri/basic/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/uri/basic" on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input, file, 7, 24, 371);
