...
/* src/routes/guide/examples/trimming-a-value/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/trimming-a-value/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div3, div2, div0, t0, t1, div1, input, t2, p, t3, span, t4, t5;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(p_nodes, "Try to press the ");

			span = claim_element(p_nodes, "SPAN", { class: true }, false);
			var span_nodes = children(span);

			t4 = claim_text(span_nodes, "Space");
			span_nodes.forEach(detach);
			t5 = claim_text(p_nodes, " bar to see");
		...
		h: function hydrate() {
			...
			span.className = "i";
			add_location(span, file, 7, 56, 381);
			p.className = "lh-copy";
			add_location(p, file, 7, 20, 345);
