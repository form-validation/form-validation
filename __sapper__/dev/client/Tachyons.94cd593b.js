...
/* src/routes/guide/plugins/transformer/numeric/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/transformer/numeric/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Price ($)");
