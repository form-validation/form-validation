...
/* src/routes/guide/examples/trimming-a-value/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/trimming-a-value/index.svelte";

// (5:0) <GuideLayout>
function create_default_slot(ctx) {
	var h1, t0, t1, section, p0, t2, code, t3, t4, t5, p1, t6, a, t7, t8, t9, t10, current;

	var demo = new Demo({
		props: {
		prefix: "/guide/examples/trimming-a-value",
		frameworks: ['tachyons']
	},
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("Trimming a value");
			t1 = space();
			section = element("section");
			p0 = element("p");
			t2 = text("The notEmpty validator does not remove the blank spaces at the beginning and ending of the value. It means that a string like ");
			code = element("code");
			t3 = text("'   '");
			t4 = text(" is treated as valid.");
			t5 = space();
			p1 = element("p");
			t6 = text("If you want to prevent this, then use the ");
			a = element("a");
			t7 = text("Transformer");
			t8 = text(" plugin to trim the value before validating it.");
			t9 = space();
			demo.$$.fragment.c();
			t10 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Trimming a value");
			...
			t2 = claim_text(p0_nodes, "The notEmpty validator does not remove the blank spaces at the beginning and ending of the value. It means that a string like ");
			...
			t4 = claim_text(p0_nodes, " is treated as valid.");
			...
			t6 = claim_text(p1_nodes, "If you want to prevent this, then use the ");
			...
			t8 = claim_text(p1_nodes, " plugin to trim the value before validating it.");
		...
		h: function hydrate() {
			...
			add_location(code, file, 8, 153, 327);
			p0.className = "lh-copy";
			add_location(p0, file, 8, 8, 182);
			a.href = "/guide/plugins/transformer";
			a.className = "blue dim link";
			add_location(a, file, 9, 69, 440);
			p1.className = "lh-copy";
			add_location(p1, file, 9, 8, 379);
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Trimming a value";
		},
