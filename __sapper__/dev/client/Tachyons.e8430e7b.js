...
/* src/routes/guide/getting-started/special-field-name/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/getting-started/special-field-name/basic/Tachyons.svelte";

// (1:0) <TachyonsLayout>
function create_default_slot(ctx) {
	var form, div4, div3, div0, t0, t1, div1, input0, t2, div2, input1, t3, div8, div7, div5, t4, t5, div6, input2, t6, div12, div11, div9, t7, t8, div10, input3, t9, div16, div15, div13, t10, div14, button, t11;
	...
	return {
		...
		l: function claim(nodes) {
			...
			input0 = claim_element(div1_nodes, "INPUT", { type: true, name: true, placeholder: true, class: true }, false);
			...
			input1 = claim_element(div2_nodes, "INPUT", { type: true, name: true, placeholder: true, class: true }, false);
			...
			t4 = claim_text(div5_nodes, "Username");
			...
			input2 = claim_element(div6_nodes, "INPUT", { type: true, name: true, class: true }, false);
			...
			t7 = claim_text(div9_nodes, "Email address");
			div9_nodes.forEach(detach);
			t8 = claim_text(div11_nodes, "\n                ");

			div10 = claim_element(div11_nodes, "DIV", { class: true }, false);
			var div10_nodes = children(div10);

			input3 = claim_element(div10_nodes, "INPUT", { type: true, name: true, class: true }, false);
			...
			button = claim_element(div14_nodes, "BUTTON", { type: true, class: true }, false);
		...
		h: function hydrate() {
			...
			add_location(div5, file, 15, 16, 699);
			attr(input2, "type", "text");
			input2.name = "user[username]";
			input2.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input2, file, 17, 20, 797);
			div6.className = "fl w-40";
			add_location(div6, file, 16, 16, 755);
			div7.className = "fl w-100";
			add_location(div7, file, 14, 12, 660);
			div8.className = "cf mb2";
			add_location(div8, file, 13, 8, 627);
			div9.className = "fl w-25 pa2";
			add_location(div9, file, 23, 16, 1030);
			attr(input3, "type", "text");
			input3.name = "user[email]";
			input3.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input3, file, 25, 20, 1133);
			div10.className = "fl w-40";
			add_location(div10, file, 24, 16, 1091);
			div11.className = "fl w-100";
			add_location(div11, file, 22, 12, 991);
			div12.className = "cf mb2";
			add_location(div12, file, 21, 8, 958);
			div13.className = "fl w-25 pa2";
			add_location(div13, file, 31, 16, 1363);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 33, 20, 1453);
			div14.className = "fl w-50";
			add_location(div14, file, 32, 16, 1411);
			div15.className = "fl w-100";
			add_location(div15, file, 30, 12, 1324);
			div16.className = "cf mb2";
			add_location(div16, file, 29, 8, 1291);
			form.id = "demoForm";
			form.method = "post";
