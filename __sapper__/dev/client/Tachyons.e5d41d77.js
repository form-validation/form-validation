...
/* src/routes/guide/validators/uri/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/uri/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Your website");
			...
			input = claim_element(div1_nodes, "INPUT", { name: true, class: true, type: true, "data-fv-uri___message": true }, false);
		...
		h: function hydrate() {
			...
			attr(input, "type", "url");
			input.dataset.fvUri___message = "The website address is not valid";
