...
/* src/routes/guide/api/remove-field/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/api/remove-field/index.svelte";

// (25:12) <PrevButton target="/guide/api/register-validator">
...
// (26:12) <NextButton target="/guide/api/reset-field">
...
function create_default_slot(ctx) {
	...
	var samplecode = new SampleCode({
		props: { lang: "javascript", code: `removeField(field: String): Core` },
		$$inline: true
	});
	...
	return {
		c: function create() {
			...
			t1 = space();
			h2 = element("h2");
			t2 = text("Remove given field by name");
			t3 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "removeField()");
			...
			t2 = claim_text(h2_nodes, "Remove given field by name");
		...
		h: function hydrate() {
			...
			div0.className = "mb3";
			add_location(div0, file, 9, 8, 242);
			add_location(sup0, file, 12, 29, 391);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 370);
			add_location(code, file, 14, 16, 491);
			add_location(sup1, file, 14, 35, 510);
			add_location(li, file, 14, 12, 487);
			ul.className = "ma0 pl3 lh-copy";
			add_location(ul, file, 13, 8, 446);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 212);
			div1.className = "flex";
			add_location(div1, file, 23, 8, 678);
			section1.className = "mv5";
			add_location(section1, file, 22, 4, 648);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • removeField() method";
		},
