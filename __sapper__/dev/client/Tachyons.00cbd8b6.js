...
/* src/routes/guide/examples/asking-fields-to-be-unique/selector/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/asking-fields-to-be-unique/selector/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			input0.className = "input-reset ba b--black-20 pa2 mb2 db w-100 js-user-email";
			input0.name = "user.email[0]";
			...
			add_location(div4, file, 13, 16, 479);
			attr(input1, "type", "text");
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100 js-user-email";
			input1.name = "user.email[1]";
			add_location(input1, file, 15, 20, 569);
			div5.className = "fl w-50";
			add_location(div5, file, 14, 16, 527);
			div6.className = "fl w-100";
			add_location(div6, file, 12, 12, 440);
			div7.className = "cf mb2";
			add_location(div7, file, 11, 8, 407);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 22, 16, 816);
			attr(input2, "type", "text");
			input2.className = "input-reset ba b--black-20 pa2 mb2 db w-100 js-user-email";
			input2.name = "user.email[2]";
			add_location(input2, file, 24, 20, 906);
			div9.className = "fl w-50";
			add_location(div9, file, 23, 16, 864);
			div10.className = "fl w-100";
			add_location(div10, file, 21, 12, 777);
			div11.className = "cf mb2";
			add_location(div11, file, 20, 8, 744);
			div12.className = "fl w-25 pa2";
			add_location(div12, file, 31, 16, 1153);
			attr(input3, "type", "text");
			input3.className = "input-reset ba b--black-20 pa2 mb2 db w-100 js-user-email";
			input3.name = "user.email[3]";
			add_location(input3, file, 33, 20, 1243);
			div13.className = "fl w-50";
			add_location(div13, file, 32, 16, 1201);
			div14.className = "fl w-100";
			add_location(div14, file, 30, 12, 1114);
			div15.className = "cf mb2";
			add_location(div15, file, 29, 8, 1081);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 40, 16, 1490);
			attr(input4, "type", "text");
			input4.className = "input-reset ba b--black-20 pa2 mb2 db w-100 js-user-email";
			input4.name = "user.email[4]";
			add_location(input4, file, 42, 20, 1580);
			div17.className = "fl w-50";
			add_location(div17, file, 41, 16, 1538);
			div18.className = "fl w-100";
			add_location(div18, file, 39, 12, 1451);
			div19.className = "cf mb2";
			add_location(div19, file, 38, 8, 1418);
			div20.className = "fl w-25 pa2";
			add_location(div20, file, 49, 16, 1827);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 51, 20, 1917);
			div21.className = "fl w-50";
			add_location(div21, file, 50, 16, 1875);
			div22.className = "fl w-100";
			add_location(div22, file, 48, 12, 1788);
			div23.className = "cf mb2";
			add_location(div23, file, 47, 8, 1755);
			form.id = "demoForm";
			form.method = "POST";
