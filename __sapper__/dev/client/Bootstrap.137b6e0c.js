...
/* src/routes/guide/validators/string-length/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/string-length/basic/Bootstrap.svelte";

// (1:0) <BootstrapLayout onLoaded={onLoaded}>
function create_default_slot(ctx) {
	var form, div1, label0, t0, t1, div0, input, t2, div3, label1, t3, t4, div2, textarea;
	...
	return {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(label1_nodes, "Bio");
			...
			textarea = claim_element(div2_nodes, "TEXTAREA", { rows: true, class: true, name: true }, false);
		...
		h: function hydrate() {
			...
			input.name = "fullName";
			add_location(input, file, 5, 16, 234);
			...
			textarea.name = "bio";
			add_location(textarea, file, 12, 16, 479);
			div2.className = "col-sm-5";
			add_location(div2, file, 11, 12, 440);
			div3.className = "form-group row";
			add_location(div3, file, 9, 8, 336);
			form.id = "demoForm";
			form.method = "POST";
