...
/* src/routes/guide/getting-started/usage/frameworks/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/getting-started/usage/frameworks/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input1, file, 14, 20, 559);
			div5.className = "fl w-50";
			add_location(div5, file, 13, 16, 517);
			...
			add_location(div8, file, 20, 16, 790);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 22, 20, 880);
			div9.className = "fl w-50";
			add_location(div9, file, 21, 16, 838);
			div10.className = "fl w-100";
			add_location(div10, file, 19, 12, 751);
			div11.className = "cf mb2";
			add_location(div11, file, 18, 8, 718);
			form.id = "demoForm";
			form.method = "post";
