...
/* src/routes/guide/examples/using-material-design-icons/material-design-event/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/using-material-design-icons/material-design-event/Tachyons.svelte";

// (2:4) <ResourceLoader urls={['https://fonts.googleapis.com/icon?family=Material+Icons']} onLoaded={onLoaded}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			input0.name = "name";
			add_location(input0, file, 7, 24, 370);
			...
			add_location(div4, file, 14, 20, 626);
			attr(input1, "type", "text");
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input1.name = "price";
			add_location(input1, file, 16, 24, 733);
			div5.className = "fl w-75";
			add_location(div5, file, 15, 20, 687);
			div6.className = "fl w-100";
			add_location(div6, file, 13, 16, 583);
			div7.className = "cf mb2";
			add_location(div7, file, 12, 12, 546);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 23, 20, 990);
			attr(input2, "type", "checkbox");
			input2.name = "size[]";
			input2.value = "s";
			add_location(input2, file, 26, 35, 1145);
			add_location(label0, file, 26, 28, 1138);
			div9.className = "mb2";
			add_location(div9, file, 25, 24, 1092);
			attr(input3, "type", "checkbox");
			input3.name = "size[]";
			input3.value = "m";
			add_location(input3, file, 29, 35, 1313);
			add_location(label1, file, 29, 28, 1306);
			div10.className = "mb2";
			add_location(div10, file, 28, 24, 1260);
			attr(input4, "type", "checkbox");
			input4.name = "size[]";
			input4.value = "l";
			add_location(input4, file, 32, 35, 1481);
			add_location(label2, file, 32, 28, 1474);
			div11.className = "mb2";
			add_location(div11, file, 31, 24, 1428);
			attr(input5, "type", "checkbox");
			input5.name = "size[]";
			input5.value = "xl";
			add_location(input5, file, 35, 35, 1649);
			add_location(label3, file, 35, 28, 1642);
			div12.className = "mb2";
			add_location(div12, file, 34, 24, 1596);
			div13.className = "fl w-75";
			add_location(div13, file, 24, 20, 1046);
			div14.className = "fl w-100";
			add_location(div14, file, 22, 16, 947);
			div15.className = "cf mb2";
			add_location(div15, file, 21, 12, 910);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 43, 20, 1912);
			attr(input6, "type", "radio");
			input6.name = "availability";
			input6.value = "yes";
			add_location(input6, file, 46, 35, 2081);
			add_location(label4, file, 46, 28, 2074);
			div17.className = "mb2";
			add_location(div17, file, 45, 24, 2028);
			attr(input7, "type", "radio");
			input7.name = "availability";
			input7.value = "no";
			add_location(input7, file, 49, 35, 2256);
			add_location(label5, file, 49, 28, 2249);
			div18.className = "mb2";
			add_location(div18, file, 48, 24, 2203);
			div19.className = "fl w-75";
			add_location(div19, file, 44, 20, 1982);
			div20.className = "fl w-100";
			add_location(div20, file, 42, 16, 1869);
			div21.className = "cf mb2";
			add_location(div21, file, 41, 12, 1832);
			div22.className = "fl w-25 pa2";
			add_location(div22, file, 57, 20, 2514);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 60, 24, 2707);
			div23.className = "fl w-50";
			add_location(div23, file, 58, 20, 2566);
			div24.className = "fl w-100";
			add_location(div24, file, 56, 16, 2471);
			div25.className = "cf mb2";
			add_location(div25, file, 55, 12, 2434);
			form.id = "demoForm";
			form.method = "POST";
    ...
    $$invalidate('fv', fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/examples/using-material-design-icons/material-design-event/tachyons',
