...
class Materialize extends Framework {
    constructor(opts) {
        super(Object.assign({}, {
...
/* src/components/demo/MaterializeLayout.svelte generated by Svelte v3.4.2 */

// (15:0) <ResourceLoader      useExternalFramework="true"     urls={[         'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css',         'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js',     ]}     onLoaded={onResourceLoaded}>
...
function create_fragment(ctx) {
	...
	return {
		...
		p: function update(changed, ctx) {
			...
			if (changed.onResourceLoaded) resourceloader_changes.onLoaded = ctx.onResourceLoaded;
...
class MaterializeLayout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<MaterializeLayout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<MaterializeLayout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { MaterializeLayout as a, Materialize as b };
