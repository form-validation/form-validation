...
/* src/routes/guide/examples/multiple-steps-wizard/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/multiple-steps-wizard/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			div21 = claim_element(form_nodes, "DIV", { class: true, "data-step": true }, false);
			...
			div43 = claim_element(form_nodes, "DIV", { class: true, "data-step": true }, false);
		...
		h: function hydrate() {
			...
			add_location(div0, file, 14, 20, 320);
			attr(input0, "type", "text");
			input0.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input0.name = "quantity";
			add_location(input0, file, 16, 24, 426);
			div1.className = "fl w-40";
			add_location(div1, file, 15, 20, 380);
			div2.className = "fl w-100";
			add_location(div2, file, 13, 16, 277);
			div3.className = "cf mb2";
			add_location(div3, file, 12, 12, 240);
			div4.className = "fl w-25 pa2";
			add_location(div4, file, 23, 20, 686);
			attr(input1, "type", "checkbox");
			input1.name = "size[]";
			input1.value = "s";
			add_location(input1, file, 26, 35, 841);
			add_location(label0, file, 26, 28, 834);
			div5.className = "mb2";
			add_location(div5, file, 25, 24, 788);
			attr(input2, "type", "checkbox");
			input2.name = "size[]";
			input2.value = "m";
			add_location(input2, file, 29, 35, 1009);
			add_location(label1, file, 29, 28, 1002);
			div6.className = "mb2";
			add_location(div6, file, 28, 24, 956);
			attr(input3, "type", "checkbox");
			input3.name = "size[]";
			input3.value = "l";
			add_location(input3, file, 32, 35, 1177);
			add_location(label2, file, 32, 28, 1170);
			div7.className = "mb2";
			add_location(div7, file, 31, 24, 1124);
			attr(input4, "type", "checkbox");
			input4.name = "size[]";
			input4.value = "xl";
			add_location(input4, file, 35, 35, 1345);
			add_location(label3, file, 35, 28, 1338);
			div8.className = "mb2";
			add_location(div8, file, 34, 24, 1292);
			div9.className = "fl w-50";
			add_location(div9, file, 24, 20, 742);
			div10.className = "fl w-100";
			add_location(div10, file, 22, 16, 643);
			div11.className = "cf mb2";
			add_location(div11, file, 21, 12, 606);
			div12.className = "fl w-25 pa2";
			add_location(div12, file, 43, 20, 1608);
			attr(input5, "type", "checkbox");
			input5.name = "color[]";
			input5.value = "white";
			add_location(input5, file, 46, 35, 1764);
			add_location(label4, file, 46, 28, 1757);
			div13.className = "mb2";
			add_location(div13, file, 45, 24, 1711);
			attr(input6, "type", "checkbox");
			input6.name = "color[]";
			input6.value = "black";
			add_location(input6, file, 49, 35, 1941);
			add_location(label5, file, 49, 28, 1934);
			div14.className = "mb2";
			add_location(div14, file, 48, 24, 1888);
			attr(input7, "type", "checkbox");
			input7.name = "color[]";
			input7.value = "red";
			add_location(input7, file, 52, 35, 2118);
			add_location(label6, file, 52, 28, 2111);
			div15.className = "mb2";
			add_location(div15, file, 51, 24, 2065);
			attr(input8, "type", "checkbox");
			input8.name = "color[]";
			input8.value = "yellow";
			add_location(input8, file, 55, 35, 2291);
			add_location(label7, file, 55, 28, 2284);
			div16.className = "mb2";
			add_location(div16, file, 54, 24, 2238);
			attr(input9, "type", "checkbox");
			input9.name = "color[]";
			input9.value = "green";
			add_location(input9, file, 58, 35, 2470);
			add_location(label8, file, 58, 28, 2463);
			div17.className = "mb2";
			add_location(div17, file, 57, 24, 2417);
			div18.className = "fl w-50";
			add_location(div18, file, 44, 20, 1665);
			div19.className = "fl w-100";
			add_location(div19, file, 42, 16, 1565);
			div20.className = "cf mb2";
			add_location(div20, file, 41, 12, 1528);
			div21.className = "js-step js-step-active svelte-vfawaf";
			div21.dataset.step = "1";
			add_location(div21, file, 11, 8, 177);
			div22.className = "fl w-25 pa2";
			add_location(div22, file, 68, 20, 2791);
			...
			add_location(input10, file, 70, 24, 2902);
			div23.className = "fl w-30 mr2";
			add_location(div23, file, 69, 20, 2852);
			...
			add_location(input11, file, 73, 24, 3111);
			div24.className = "fl w-30";
			add_location(div24, file, 72, 20, 3065);
			div25.className = "fl w-100";
			add_location(div25, file, 67, 16, 2748);
			div26.className = "cf mb2";
			add_location(div26, file, 66, 12, 2711);
			div27.className = "fl w-25 pa2";
			add_location(div27, file, 80, 20, 3387);
			attr(input12, "type", "text");
			input12.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input12.name = "cellPhone";
			add_location(input12, file, 82, 24, 3497);
			div28.className = "fl w-40";
			add_location(div28, file, 81, 20, 3451);
			div29.className = "fl w-100";
			add_location(div29, file, 79, 16, 3344);
			div30.className = "cf mb2";
			add_location(div30, file, 78, 12, 3307);
			div31.className = "fl w-25 pa2";
			add_location(div31, file, 89, 20, 3750);
			attr(input13, "type", "text");
			input13.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input13.name = "street";
			add_location(input13, file, 91, 24, 3854);
			div32.className = "fl w-75";
			add_location(div32, file, 90, 20, 3808);
			div33.className = "fl w-100";
			add_location(div33, file, 88, 16, 3707);
			div34.className = "cf mb2";
			add_location(div34, file, 87, 12, 3670);
			div35.className = "fl w-25 pa2";
			add_location(div35, file, 98, 20, 4104);
			attr(input14, "type", "text");
			input14.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input14.name = "city";
			add_location(input14, file, 100, 24, 4206);
			div36.className = "fl w-40";
			add_location(div36, file, 99, 20, 4160);
			div37.className = "fl w-100";
			add_location(div37, file, 97, 16, 4061);
			div38.className = "cf mb2";
			add_location(div38, file, 96, 12, 4024);
			div39.className = "fl w-25 pa2";
			add_location(div39, file, 107, 20, 4454);
			attr(input15, "type", "text");
			input15.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input15.name = "zipCode";
			add_location(input15, file, 109, 24, 4559);
			div40.className = "fl w-40";
			add_location(div40, file, 108, 20, 4513);
			div41.className = "fl w-100";
			add_location(div41, file, 106, 16, 4411);
			div42.className = "cf mb2";
			add_location(div42, file, 105, 12, 4374);
			div43.className = "js-step svelte-vfawaf";
			div43.dataset.step = "2";
			add_location(div43, file, 65, 8, 2663);
			div44.className = "fl w-25 pa2";
			add_location(div44, file, 117, 16, 4813);
			button0.type = "button";
			button0.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			button0.id = "prevButton";
			add_location(button0, file, 119, 20, 4903);
			button1.type = "button";
			button1.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			button1.id = "nextButton";
			add_location(button1, file, 120, 20, 5024);
			div45.className = "fl w-50";
			add_location(div45, file, 118, 16, 4861);
			div46.className = "fl w-100";
			add_location(div46, file, 116, 12, 4774);
			div47.className = "cf mb2";
			add_location(div47, file, 115, 8, 4741);
			form.id = "demoForm";
			form.method = "POST";
			set_style(form, "height", "400px");
			add_location(form, file, 10, 4, 111);
		},
