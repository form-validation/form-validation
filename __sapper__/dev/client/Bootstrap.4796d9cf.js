...
/* src/routes/guide/examples/changing-success-and-error-colors/override-colors/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/changing-success-and-error-colors/override-colors/Bootstrap.svelte";

// (13:0) <BootstrapLayout onLoaded={onLoaded}>
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 15, 12, 423);
			attr(input0, "type", "text");
			input0.className = "form-control";
			input0.name = "username";
			add_location(input0, file, 17, 16, 530);
			div0.className = "col-sm-6";
			add_location(div0, file, 16, 12, 491);
			div1.className = "form-group row";
			add_location(div1, file, 14, 8, 382);
			label1.className = "col-sm-3 col-form-label";
			add_location(label1, file, 22, 12, 677);
			attr(input1, "type", "text");
			input1.className = "form-control";
			input1.name = "password";
			add_location(input1, file, 24, 16, 784);
			div2.className = "col-sm-6";
			add_location(div2, file, 23, 12, 745);
			div3.className = "form-group row";
			add_location(div3, file, 21, 8, 636);
			button.type = "submit";
			button.className = "btn btn-primary";
			add_location(button, file, 30, 16, 982);
			div4.className = "col-sm-9 offset-sm-3";
			add_location(div4, file, 29, 12, 931);
			div5.className = "form-group row";
			add_location(div5, file, 28, 8, 890);
			form.id = "demoForm";
			form.className = "my-form";
			form.method = "POST";
			add_location(form, file, 13, 4, 323);
		},
