...
/* src/routes/guide/validators/string-case/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/string-case/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Credit card holder");
		...
		h: function hydrate() {
			...
			input.name = "name";
			add_location(input, file, 5, 16, 243);
			div0.className = "col-sm-5";
			add_location(div0, file, 4, 12, 204);
