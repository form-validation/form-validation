...
/* src/routes/guide/validators/credit-card/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/credit-card/basic/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender='/guide/validators/credit-card/basic' on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Credit card number");
		...
		h: function hydrate() {
			...
			add_location(div0, file, 5, 20, 269);
			attr(input, "type", "text");
			input.name = "cc";
			input.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input, file, 7, 24, 385);
			div1.className = "fl w-50";
			add_location(div1, file, 6, 20, 339);
			div2.className = "fl w-100";
			add_location(div2, file, 4, 16, 226);
			div3.className = "cf mb2";
			add_location(div3, file, 3, 12, 189);
			form.id = "demoForm";
			form.method = "post";
			add_location(form, file, 2, 8, 142);
		},
