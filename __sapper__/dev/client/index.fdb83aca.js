...
/* src/routes/guide/examples/asking-credit-card-number-to-match-with-selected-type/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/asking-credit-card-number-to-match-with-selected-type/index.svelte";
...
function create_default_slot(ctx) {
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/examples/asking-credit-card-number-to-match-with-selected-type",
		frameworks: ['tachyons']
	},
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("Asking credit card number to match with selected type");
			t1 = space();
			section = element("section");
			p = element("p");
			t2 = text("The following form asks to fill in the valid credit card number which matches the selected type.");
			t3 = space();
			demo.$$.fragment.c();
			t4 = space();
			examples.$$.fragment.c();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Asking credit card number to match with selected type");
			...
			t2 = claim_text(p_nodes, "The following form asks to fill in the valid credit card number which matches the selected type.");
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Asking credit card number to match with selected type";
		},
