...
/* src/routes/guide/validators/email-address/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/email-address/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			input = claim_element(div1_nodes, "INPUT", { name: true, class: true, type: true, "data-fv-email-address___message": true }, false);
		...
		h: function hydrate() {
			...
			input.dataset.fvEmailAddress___message = "The value is not a valid email address";
