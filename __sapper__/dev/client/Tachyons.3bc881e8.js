...
/* src/routes/guide/validators/identical/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/identical/basic/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(div4_nodes, "Retype password");
		...
		h: function hydrate() {
			...
			add_location(div4, file, 12, 16, 491);
			attr(input1, "type", "password");
			input1.name = "confirmPassword";
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			add_location(input1, file, 14, 20, 596);
			div5.className = "fl w-50";
			add_location(div5, file, 13, 16, 554);
			div6.className = "fl w-100";
			add_location(div6, file, 11, 12, 452);
			div7.className = "cf mb2";
			add_location(div7, file, 10, 8, 419);
			form.id = "demoForm";
			form.method = "post";
