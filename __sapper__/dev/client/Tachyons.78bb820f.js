...
/* src/routes/guide/examples/creating-a-custom-validator/dynamic-message/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/creating-a-custom-validator/dynamic-message/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "New password");
		...
		h: function hydrate() {
			...
			input.name = "pwd";
			add_location(input, file, 6, 20, 242);
    ...
    const fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/examples/creating-a-custom-validator/dynamic-message/tachyons',
