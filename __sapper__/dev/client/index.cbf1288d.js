...
/* src/routes/guide/validators/hex/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/hex/index.svelte";
...
// (54:12) <PrevButton target="/guide/validators/grid">
...
// (55:12) <NextButton target="/guide/validators/iban">
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("hex validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a hexadecimal number");
			t3 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t21 = text("data-fv-hex___message");
			t22 = space();
			td2 = element("td");
			t23 = text("String");
			t24 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "hex validator");
			...
			t2 = claim_text(h2_nodes, "Validate a hexadecimal number");
			...
			t21 = claim_text(code1_nodes, "data-fv-hex___message");
		...
		h: function hydrate() {
			...
			add_location(h30, file, 11, 8, 274);
			a.href = "/guide/plugins/declarative";
			a.className = "blue dim link";
			add_location(a, file, 12, 95, 400);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 313);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 613);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 673);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 743);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 803);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 564);
			add_location(code0, file, 21, 36, 953);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 933);
			add_location(code1, file, 22, 36, 1015);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 995);
			...
			add_location(tr1, file, 20, 12, 884);
			table.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table, file, 13, 8, 494);
			add_location(h31, file, 28, 8, 1206);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 208);
			div.className = "flex";
			add_location(div, file, 52, 8, 1679);
			section1.className = "mv5";
			add_location(section1, file, 51, 4, 1649);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • hex validator";
		},
