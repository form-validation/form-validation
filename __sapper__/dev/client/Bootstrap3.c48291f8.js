...
/* src/routes/guide/examples/using-glyphicons-icons/Bootstrap3.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/using-glyphicons-icons/Bootstrap3.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(button, file, 51, 16, 2078);
