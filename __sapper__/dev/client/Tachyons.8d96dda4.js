...
import { a as color } from './chunk.a5793346.js';
...
/* src/routes/guide/validators/color/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/color/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Color");
			...
			input = claim_element(div1_nodes, "INPUT", { class: true, name: true, type: true, "data-fv-color__message": true }, false);
		...
		h: function hydrate() {
			...
			input.dataset.fvColor__message = "The color code is not valid";
