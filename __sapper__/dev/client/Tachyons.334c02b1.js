...
/* src/routes/guide/validators/integer/html5/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/integer/html5/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		c: function create() {
			...
			div2 = element("div");
			div0 = element("div");
			t0 = text("Type an integer number");
			t1 = space();
			div1 = element("div");
			input = element("input");
			this.h();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Type an integer number");
			...
			input = claim_element(div1_nodes, "INPUT", { name: true, class: true, type: true, "data-fv-integer___message": true }, false);
		...
		h: function hydrate() {
			...
			input.dataset.fvInteger___message = "The value is not an integer";
			add_location(input, file, 6, 20, 248);
