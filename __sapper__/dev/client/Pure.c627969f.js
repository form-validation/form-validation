...
/* src/routes/guide/getting-started/usage/frameworks/Pure.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/getting-started/usage/frameworks/Pure.svelte";

// (1:0) <PureLayout onLoaded={onLoaded}>
function create_default_slot(ctx) {
	var div4, div3, form, div0, label0, t0, t1, input0, t2, div1, label1, t3, t4, input1, t5, div2, label2, t6, button, t7;
	...
	return {
		...
		l: function claim(nodes) {
			...
			form = claim_element(div3_nodes, "FORM", { id: true, class: true, method: true }, false);
		...
		h: function hydrate() {
			...
			add_location(input0, file, 6, 20, 285);
			div0.className = "pure-control-group";
			add_location(div0, file, 4, 16, 188);
			add_location(label1, file, 10, 20, 439);
			input1.name = "password";
			attr(input1, "type", "password");
			input1.placeholder = "Password";
			add_location(input1, file, 11, 20, 483);
			div1.className = "pure-control-group";
			add_location(div1, file, 9, 16, 386);
			add_location(label2, file, 15, 20, 641);
			button.type = "submit";
			button.className = "pure-button pure-button-primary";
			add_location(button, file, 16, 20, 677);
			div2.className = "pure-control-group";
			add_location(div2, file, 14, 16, 588);
			form.id = "demoForm";
			form.className = "pure-form pure-form-aligned";
			form.method = "POST";
			add_location(form, file, 3, 12, 101);
			div3.className = "pure-u-1";
			add_location(div3, file, 2, 8, 66);
			div4.className = "pure-g";
			add_location(div4, file, 1, 4, 37);
		},
