...
/* src/routes/guide/validators/rtn/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/rtn/index.svelte";
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(tr, file, 59, 12, 2165);
		},
...
// (99:12) <PrevButton target="/guide/validators/remote">
...
// (100:12) <NextButton target="/guide/validators/sedol">
function create_default_slot_1(ctx) {
	var t;

	return {
		c: function create() {
			t = text("sedol validator");
		},

		l: function claim(nodes) {
			t = claim_text(nodes, "sedol validator");
		},
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/rtn/basic",
...
` },
	...
	var relatedvalidators = new RelatedValidators({
		props: { validators: ['bic', 'creditCard', 'iban'] },
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("rtn validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a ");
			a0 = element("a");
			t3 = text("RTN (Routing transit number)");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-rtn___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
			...
			t31 = space();
			p1 = element("p");
			t32 = text("You can click on sample to see if it's a valid or invalid RTN.");
			t33 = space();
			...
			t40 = space();
			p2 = element("p");
			t41 = text("The following snippet shows how to use the rtn validator with ES6 module:");
			t42 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "rtn validator");
			...
			t3 = claim_text(a0_nodes, "RTN (Routing transit number)");
			...
			t22 = claim_text(code1_nodes, "data-fv-rtn___message");
			...
			t32 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid RTN.");
			...
			t41 = claim_text(p2_nodes, "The following snippet shows how to use the rtn validator with ES6 module:");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/ABA_routing_transit_number";
			a0.className = "blue dim link";
			add_location(a0, file, 6, 37, 179);
			h2.className = "f4 fw4 tc";
			add_location(h2, file, 6, 4, 146);
			add_location(h30, file, 11, 8, 377);
			a1.href = "/guide/plugins/declarative";
			a1.className = "blue dim link";
			add_location(a1, file, 12, 95, 503);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 416);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 716);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 776);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 846);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 906);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 667);
			add_location(code0, file, 21, 36, 1056);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 1036);
			add_location(code1, file, 22, 36, 1118);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1098);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1174);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1222);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 987);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table0, file, 13, 8, 597);
			add_location(h31, file, 28, 8, 1309);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 311);
			p1.className = "lh-copy";
			add_location(p1, file, 52, 8, 1768);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 55, 16, 1985);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 56, 16, 2047);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 54, 12, 1936);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 53, 8, 1862);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1696);
			p2.className = "lh-copy";
			add_location(p2, file, 71, 8, 2528);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2451);
			div.className = "flex";
			add_location(div, file, 97, 8, 3197);
			section3.className = "mv5";
			add_location(section3, file, 96, 4, 3167);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • rtn validator";
		},
