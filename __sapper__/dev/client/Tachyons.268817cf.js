...
/* src/routes/guide/validators/ip/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/ip/basic/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/ip/basic" on:received={receive}>
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "IP address");
		...
		h: function hydrate() {
			...
			add_location(input, file, 7, 24, 368);
