...
/* src/routes/guide/plugins/transformer/phone/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/transformer/phone/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "US phone number");
		...
		h: function hydrate() {
			...
			add_location(input, file, 6, 20, 241);
			div1.className = "fl w-50";
			add_location(div1, file, 5, 16, 199);
