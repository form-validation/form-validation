...
/* src/routes/guide/validators/mac/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/mac/index.svelte";
...
// (54:12) <PrevButton target="/guide/validators/less-than">
...
// (55:12) <NextButton target="/guide/validators/meid">
...
function create_default_slot(ctx) {
	var h1, t0, t1, h2, t2, t3, section0, t4, h30, t5, t6, p, t7, a, t8, t9, t10, table, tr0, th0, t11, t12, th1, t13, t14, th2, t15, t16, th3, t17, t18, tr1, td0, code0, t19, t20, td1, code1, t21, t22, td2, t23, t24, td3, t25, t26, h31, t27, t28, t29, t30, section1, div, t31, current;
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("mac validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a MAC address");
			t3 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t21 = text("data-fv-mac___message");
			t22 = space();
			td2 = element("td");
			t23 = text("String");
			t24 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "mac validator");
			...
			t2 = claim_text(h2_nodes, "Validate a MAC address");
			...
			t21 = claim_text(code1_nodes, "data-fv-mac___message");
		...
		h: function hydrate() {
			...
			add_location(h30, file, 11, 8, 267);
			a.href = "/guide/plugins/declarative";
			a.className = "blue dim link";
			add_location(a, file, 12, 95, 393);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 306);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 606);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 666);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 736);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 796);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 557);
			add_location(code0, file, 21, 36, 946);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 926);
			add_location(code1, file, 22, 36, 1008);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 988);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1064);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1112);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 877);
			table.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table, file, 13, 8, 487);
			add_location(h31, file, 28, 8, 1199);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 201);
			div.className = "flex";
			add_location(div, file, 52, 8, 1675);
			section1.className = "mv5";
			add_location(section1, file, 51, 4, 1645);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • mac validator";
		},
