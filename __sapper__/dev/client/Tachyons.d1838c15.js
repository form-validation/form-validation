...
/* src/routes/guide/plugins/declarative/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/declarative/basic/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			input0 = claim_element(div1_nodes, "INPUT", { type: true, class: true, name: true, "data-fv-not-empty": true, "data-fv-not-empty___message": true, "data-fv-string-length": true, "data-fv-string-length___min": true, "data-fv-string-length___max": true, "data-fv-string-length___message": true, "data-fv-regexp": true, "data-fv-regexp___regexp": true, "data-fv-regexp___message": true }, false);
			...
			input1 = claim_element(div5_nodes, "INPUT", { type: true, class: true, name: true, "data-fv-not-empty": true, "data-fv-not-empty___message": true, "data-fv-numeric": true, "data-fv-numeric___message": true }, false);
			...
			input2 = claim_element(label0_nodes, "INPUT", { type: true, name: true, value: true, "data-fv-not-empty": true, "data-fv-not-empty___message": true }, false);
			...
			input6 = claim_element(label4_nodes, "INPUT", { type: true, name: true, value: true, "data-fv-not-empty": true, "data-fv-not-empty___message": true }, false);
		...
		h: function hydrate() {
			...
			input0.name = "name";
			input0.dataset.fvNotEmpty = "true";
			input0.dataset.fvNotEmpty___message = "The name is required";
			input0.dataset.fvStringLength = "true";
			input0.dataset.fvStringLength___min = "6";
			input0.dataset.fvStringLength___max = "30";
			input0.dataset.fvStringLength___message = "The name must be more than 6 and less than 30 characters long";
			input0.dataset.fvRegexp = "true";
			input0.dataset.fvRegexp___regexp = "^[a-zA-Z0-9_]+$";
			input0.dataset.fvRegexp___message = "The name can only consist of alphabetical, number and underscore";
			...
			add_location(div4, file, 24, 16, 1106);
			attr(input1, "type", "text");
			input1.className = "input-reset ba b--black-20 pa2 mb2 db w-100";
			input1.name = "price";
			input1.dataset.fvNotEmpty = "true";
			input1.dataset.fvNotEmpty___message = "The price is required";
			input1.dataset.fvNumeric = "true";
			input1.dataset.fvNumeric___message = "The price must be a number";
			add_location(input1, file, 26, 20, 1205);
			div5.className = "fl w-30";
			add_location(div5, file, 25, 16, 1163);
			div6.className = "fl w-100";
			add_location(div6, file, 23, 12, 1067);
			div7.className = "cf mb2";
			add_location(div7, file, 22, 8, 1034);
			div8.className = "fl w-25 pa2";
			add_location(div8, file, 38, 16, 1686);
			attr(input2, "type", "checkbox");
			input2.name = "size[]";
			input2.value = "s";
			input2.dataset.fvNotEmpty = "true";
			input2.dataset.fvNotEmpty___message = "The size is required";
			add_location(input2, file, 42, 28, 1858);
			add_location(label0, file, 41, 24, 1822);
			div9.className = "mb2";
			add_location(div9, file, 40, 20, 1780);
			attr(input3, "type", "checkbox");
			input3.name = "size[]";
			input3.value = "m";
			add_location(input3, file, 48, 31, 2180);
			add_location(label1, file, 48, 24, 2173);
			div10.className = "mb2";
			add_location(div10, file, 47, 20, 2131);
			attr(input4, "type", "checkbox");
			input4.name = "size[]";
			input4.value = "l";
			add_location(input4, file, 51, 31, 2336);
			add_location(label2, file, 51, 24, 2329);
			div11.className = "mb2";
			add_location(div11, file, 50, 20, 2287);
			attr(input5, "type", "checkbox");
			input5.name = "size[]";
			input5.value = "xl";
			add_location(input5, file, 54, 31, 2492);
			add_location(label3, file, 54, 24, 2485);
			div12.className = "mb2";
			add_location(div12, file, 53, 20, 2443);
			div13.className = "fl w-75";
			add_location(div13, file, 39, 16, 1738);
			div14.className = "fl w-100";
			add_location(div14, file, 37, 12, 1647);
			div15.className = "cf mb2";
			add_location(div15, file, 36, 8, 1614);
			div16.className = "fl w-25 pa2";
			add_location(div16, file, 62, 16, 2723);
			attr(input6, "type", "radio");
			input6.name = "availability";
			input6.value = "yes";
			input6.dataset.fvNotEmpty = "true";
			input6.dataset.fvNotEmpty___message = "The availability option is required";
			add_location(input6, file, 66, 28, 2909);
			add_location(label4, file, 65, 24, 2873);
			div17.className = "mb2";
			add_location(div17, file, 64, 20, 2831);
			attr(input7, "type", "radio");
			input7.name = "availability";
			input7.value = "no";
			add_location(input7, file, 72, 31, 3252);
			add_location(label5, file, 72, 24, 3245);
			div18.className = "mb2";
			add_location(div18, file, 71, 20, 3203);
			div19.className = "fl w-75";
			add_location(div19, file, 63, 16, 2789);
			div20.className = "fl w-100";
			add_location(div20, file, 61, 12, 2684);
			div21.className = "cf mb2";
			add_location(div21, file, 60, 8, 2651);
			div22.className = "fl w-25 pa2";
			add_location(div22, file, 80, 16, 3482);
			button.type = "submit";
			button.className = "ba b--black-20 bg-blue white ph3 pv2 br2";
			add_location(button, file, 82, 20, 3572);
			div23.className = "fl w-50";
			add_location(div23, file, 81, 16, 3530);
			div24.className = "fl w-100";
			add_location(div24, file, 79, 12, 3443);
			div25.className = "cf mb2";
			add_location(div25, file, 78, 8, 3410);
			form.id = "demoForm";
			form.method = "POST";
    ...
    const fv = formValidation(document.getElementById('demoForm'), {
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/plugins/declarative/basic/tachyons',
