...
/* src/routes/guide/plugins/mini/stacked-form/Mini.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/mini/stacked-form/Mini.svelte";

// (1:0) <MiniLayout onLoaded={onLoaded}>
function create_default_slot(ctx) {
	var form, div2, div0, label0, t0, t1, div1, input0, t2, div5, div3, label1, t3, t4, div4, input1, t5, div12, div6, label2, t6, t7, div11, div7, input2, t8, t9, div8, input3, t10, t11, div9, input4, t12, t13, div10, input5, t14, t15, div17, div13, label3, t16, t17, div16, div14, input6, t18, t19, div15, input7, t20, t21, div18, button, t22;
	...
	return {
		...
		l: function claim(nodes) {
			form = claim_element(nodes, "FORM", { id: true, method: true, class: true, style: true }, false);
		...
		h: function hydrate() {
			add_location(label0, file, 4, 16, 237);
			div0.className = "col-sm-12";
			add_location(div0, file, 3, 12, 197);
			attr(input0, "type", "text");
			input0.name = "name";
			set_style(input0, "width", "100%");
			add_location(input0, file, 7, 16, 335);
			div1.className = "col-sm-6";
			add_location(div1, file, 6, 12, 296);
			div2.className = "row";
			add_location(div2, file, 2, 8, 167);
			add_location(label1, file, 13, 16, 502);
			div3.className = "col-sm-12";
			add_location(div3, file, 12, 12, 462);
			attr(input1, "type", "text");
			input1.name = "price";
			set_style(input1, "width", "100%");
			add_location(input1, file, 16, 16, 597);
			div4.className = "col-sm-4";
			add_location(div4, file, 15, 12, 558);
			div5.className = "row";
			add_location(div5, file, 11, 8, 432);
			add_location(label2, file, 23, 16, 774);
			div6.className = "col-sm-12";
			add_location(div6, file, 22, 12, 734);
			attr(input2, "type", "checkbox");
			input2.name = "size[]";
			input2.value = "s";
			add_location(input2, file, 26, 21, 869);
			add_location(div7, file, 26, 16, 864);
			attr(input3, "type", "checkbox");
			input3.name = "size[]";
			input3.value = "m";
			add_location(input3, file, 27, 21, 948);
			add_location(div8, file, 27, 16, 943);
			attr(input4, "type", "checkbox");
			input4.name = "size[]";
			input4.value = "l";
			add_location(input4, file, 28, 21, 1027);
			add_location(div9, file, 28, 16, 1022);
			attr(input5, "type", "checkbox");
			input5.name = "size[]";
			input5.value = "xl";
			add_location(input5, file, 29, 21, 1106);
			add_location(div10, file, 29, 16, 1101);
			div11.className = "col-sm-9";
			add_location(div11, file, 25, 12, 825);
			div12.className = "row";
			add_location(div12, file, 21, 8, 704);
			add_location(label3, file, 35, 16, 1279);
			div13.className = "col-sm-12";
			add_location(div13, file, 34, 12, 1239);
			attr(input6, "type", "radio");
			input6.name = "availability";
			input6.value = "yes";
			add_location(input6, file, 38, 21, 1388);
			add_location(div14, file, 38, 16, 1383);
			attr(input7, "type", "radio");
			input7.name = "availability";
			input7.value = "no";
			add_location(input7, file, 39, 21, 1474);
			add_location(div15, file, 39, 16, 1469);
			div16.className = "col-sm-9";
			add_location(div16, file, 37, 12, 1344);
			div17.className = "row";
			add_location(div17, file, 33, 8, 1209);
			button.type = "submit";
			button.className = "primary";
			add_location(button, file, 44, 12, 1610);
			div18.className = "row";
			add_location(div18, file, 43, 8, 1580);
			form.id = "demoForm";
			form.method = "POST";
    ...
    $$invalidate('fv', fv = formValidation(document.getElementById('demoForm'), {
        ...
        plugins: {
            ...
            demoFrame: new DemoFrame({
                sender: '/guide/plugins/mini/stacked-form/mini',
