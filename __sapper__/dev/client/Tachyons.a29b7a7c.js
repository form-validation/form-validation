...
import { a as iban } from './chunk.8537a0a1.js';
...
/* src/routes/guide/validators/iban/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/iban/basic/Tachyons.svelte";

// (2:4) <ReceiveMessage channel="SAMPLE_FIELD_VALUE" sender="/guide/validators/iban/basic" on:received={receive}>
