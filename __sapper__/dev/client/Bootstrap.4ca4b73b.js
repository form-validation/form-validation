...
/* src/routes/guide/validators/uri/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/uri/basic/Bootstrap.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Your website");
		...
		h: function hydrate() {
			...
			input.name = "website";
			add_location(input, file, 6, 20, 366);
