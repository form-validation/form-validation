...
/* src/routes/guide/validators/ip/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/ip/basic/Bootstrap.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "IP address");
		...
		h: function hydrate() {
			...
			add_location(label, file, 4, 16, 246);
			attr(input, "type", "text");
			input.className = "form-control";
			input.name = "ip";
			add_location(input, file, 6, 20, 363);
			div0.className = "col-sm-9";
