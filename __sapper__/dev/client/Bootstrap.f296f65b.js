...
/* src/routes/guide/plugins/bootstrap/without-label-form/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/bootstrap/without-label-form/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input0, file, 3, 12, 122);
			...
			add_location(input1, file, 7, 12, 269);
			div1.className = "form-group";
			add_location(div1, file, 6, 8, 232);
			button.type = "submit";
			button.className = "btn btn-primary";
			add_location(button, file, 11, 8, 462);
			form.id = "demoForm";
			form.method = "POST";
