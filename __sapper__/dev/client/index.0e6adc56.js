...
/* src/routes/guide/plugins/pure/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/plugins/pure/index.svelte";
...
// (69:12) <PrevButton target="/guide/plugins/password-strength">
...
// (70:12) <NextButton target="/guide/plugins/recaptcha">
...
function create_default_slot(ctx) {
	var h1, t0, t1, h2, t2, a, t3, t4, t5, section0, t6, p0, t7, t8, t9, p1, t10, code, t11, t12, t13, p2, t14, t15, section1, t16, t17, section2, t18, t19, section3, t20, ul, li, t21, t22, section4, div, t23, current;
...
` },
	...
	var demo0 = new Demo({
		props: {
		prefix: "/guide/plugins/pure/horizontal-form",
		frameworks: ['pure']
	},
		$$inline: true
	});
	...
	var demo1 = new Demo({
		props: {
		prefix: "/guide/plugins/pure/stacked-form",
		frameworks: ['pure']
	},
		$$inline: true
	});
	...
	return {
		c: function create() {
			...
			a = element("a");
			t3 = text("Pure");
			t4 = text(" library. Support Pure v1.0.0");
			t5 = space();
			section0 = element("section");
			heading0.$$.fragment.c();
			t6 = space();
			p0 = element("p");
			t7 = text("The following piece of code is the starting point to validate the form made in Pure:");
			t8 = space();
			...
			t13 = space();
			p2 = element("p");
			t14 = text("The next sections list out some examples of various forms made with Pure.");
			t15 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Pure plugin");
			...
			t3 = claim_text(a_nodes, "Pure");
			a_nodes.forEach(detach);
			t4 = claim_text(h2_nodes, " library. Support Pure v1.0.0");
			...
			t7 = claim_text(p0_nodes, "The following piece of code is the starting point to validate the form made in Pure:");
			...
			t14 = claim_text(p2_nodes, "The next sections list out some examples of various forms made with Pure.");
			...
			t21 = claim_text(li_nodes, "v1.0.0: First release");
		...
		h: function hydrate() {
			...
			add_location(p0, file, 10, 8, 349);
			add_location(code, file, 45, 109, 1558);
			p1.className = "lh-copy";
			add_location(p1, file, 45, 8, 1457);
			p2.className = "lh-copy";
			add_location(p2, file, 46, 8, 1685);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 286);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1802);
			section2.className = "mv5";
			add_location(section2, file, 54, 4, 1971);
			add_location(li, file, 62, 12, 2246);
			ul.className = "pa0 ma0 ml3 lh-copy";
			add_location(ul, file, 61, 8, 2201);
			section3.className = "mv5";
			add_location(section3, file, 59, 4, 2134);
			div.className = "flex";
			add_location(div, file, 67, 8, 2341);
			section4.className = "mv5";
			add_location(section4, file, 66, 4, 2311);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • Pure plugin";
		},
