...
/* src/routes/guide/api/off/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/api/off/index.svelte";

// (30:12) <PrevButton target="/guide/api/get-plugin">
function create_default_slot_2(ctx) {
	var t;

	return {
		c: function create() {
			t = text("getPlugin() method");
		},

		l: function claim(nodes) {
			t = claim_text(nodes, "getPlugin() method");
		},
...
// (31:12) <NextButton target="/guide/api/on">
...
function create_default_slot(ctx) {
	...
	var samplecode0 = new SampleCode({
		props: { lang: "javascript", code: `off(event: String, func: Function): Core` },
		$$inline: true
	});
...
` },
	...
	return {
		c: function create() {
			...
			t1 = space();
			h2 = element("h2");
			t2 = text("Remove the given handler on particular event.");
			t3 = space();
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h2_nodes, "Remove the given handler on particular event.");
		...
		h: function hydrate() {
			...
			div0.className = "mb3";
			add_location(div0, file, 9, 8, 245);
			add_location(sup0, file, 12, 29, 402);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 381);
			add_location(code0, file, 14, 16, 506);
			add_location(sup1, file, 14, 35, 525);
			add_location(li0, file, 14, 12, 502);
			add_location(code1, file, 15, 16, 576);
			add_location(sup2, file, 15, 34, 594);
			add_location(li1, file, 15, 12, 572);
			ul.className = "ma0 mb3 pl3 lh-copy";
			add_location(ul, file, 13, 8, 457);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 215);
			div1.className = "flex";
			add_location(div1, file, 28, 8, 888);
			section1.className = "mv5";
			add_location(section1, file, 27, 4, 858);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • off() method";
		},
