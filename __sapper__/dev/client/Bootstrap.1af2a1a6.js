...
/* src/routes/guide/validators/different/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/different/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(input1, file, 12, 16, 517);
			div2.className = "col-sm-5";
			add_location(div2, file, 11, 12, 478);
			div3.className = "form-group row";
			add_location(div3, file, 9, 8, 369);
			form.id = "demoForm";
			form.method = "POST";
...
onDestroy(() => {
	...
	return { onLoaded, changeUsername };
}
