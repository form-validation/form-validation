...
/* src/routes/guide/validators/file/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/file/basic/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			input.name = "avatar";
			add_location(input, file, 5, 16, 231);
			div0.className = "col-sm-5";
			add_location(div0, file, 4, 12, 192);
