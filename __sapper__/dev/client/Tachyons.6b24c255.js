...
/* src/routes/guide/validators/sedol/basic/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/sedol/basic/Tachyons.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "SEDOL");
		...
		h: function hydrate() {
			...
			add_location(input, file, 7, 24, 366);
