...
/* src/components/demo/SemanticLayout.svelte generated by Svelte v3.4.2 */

// (23:0) <ResourceLoader useExternalFramework="true" urls={['https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css']} onLoaded={onLoaded}>
...
class SemanticLayout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<SemanticLayout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<SemanticLayout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { SemanticLayout as a, Semantic as b };
