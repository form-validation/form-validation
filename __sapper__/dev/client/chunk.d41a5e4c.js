...
/* src/components/demo/Bootstrap3Layout.svelte generated by Svelte v3.4.2 */

const file = "src/components/demo/Bootstrap3Layout.svelte";

// (11:0) <ResourceLoader useExternalFramework="true" urls={['https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.4.1/css/bootstrap.min.css']} onLoaded={onLoaded}>
...
class Bootstrap3Layout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<Bootstrap3Layout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<Bootstrap3Layout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { Bootstrap3Layout as a, Bootstrap3 as b };
