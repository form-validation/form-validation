...
/* src/routes/guide/validators/cusip/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/cusip/index.svelte";
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(tr, file, 59, 12, 2082);
		},
...
// (99:12) <PrevButton target="/guide/validators/credit-card">
...
// (100:12) <NextButton target="/guide/validators/date">
...
function create_default_slot(ctx) {
	var h1, t0, t1, h2, t2, t3, section0, t4, h30, t5, t6, p0, t7, a, t8, t9, t10, table0, tr0, th0, t11, t12, th1, t13, t14, th2, t15, t16, th3, t17, t18, tr1, td0, code0, t19, t20, td1, code1, t21, t22, td2, t23, t24, td3, t25, t26, h31, t27, t28, t29, section1, t30, p1, t31, t32, table1, tr2, th4, t33, t34, th5, t35, t36, t37, t38, section2, t39, p2, t40, t41, t42, t43, section3, div, t44, current;
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/cusip/basic",
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("cusip validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a CUSIP number");
			t3 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t21 = text("data-fv-cusip___message");
			t22 = space();
			td2 = element("td");
			t23 = text("String");
			t24 = space();
			...
			t30 = space();
			p1 = element("p");
			t31 = text("You can click on sample to see if it's a valid or invalid CUSIP number.");
			t32 = space();
			...
			t39 = space();
			p2 = element("p");
			t40 = text("The following snippet shows how to use the cusip validator with ES6 module:");
			t41 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "cusip validator");
			...
			t2 = claim_text(h2_nodes, "Validate a CUSIP number");
			...
			t21 = claim_text(code1_nodes, "data-fv-cusip___message");
			...
			t31 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid CUSIP number.");
			...
			t33 = claim_text(th4_nodes, "Sample");
			...
			t35 = claim_text(th5_nodes, "Is valid?");
			th5_nodes.forEach(detach);
			tr2_nodes.forEach(detach);
			t36 = claim_text(table1_nodes, "\n            ");
			...
			t40 = claim_text(p2_nodes, "The following snippet shows how to use the cusip validator with ES6 module:");
		...
		h: function hydrate() {
			...
			add_location(code1, file, 22, 36, 1013);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 993);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1071);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1119);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 882);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table0, file, 13, 8, 492);
			add_location(h31, file, 28, 8, 1206);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 206);
			p1.className = "lh-copy";
			add_location(p1, file, 52, 8, 1676);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 55, 16, 1902);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 56, 16, 1964);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 54, 12, 1853);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 53, 8, 1779);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1604);
			p2.className = "lh-copy";
			add_location(p2, file, 71, 8, 2449);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2372);
			div.className = "flex";
			add_location(div, file, 97, 8, 3120);
			section3.className = "mv5";
			add_location(section3, file, 96, 4, 3090);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • cusip validator";
		},
