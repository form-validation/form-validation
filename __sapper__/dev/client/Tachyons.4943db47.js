...
/* src/routes/guide/examples/switching-validators-on-the-same-field/Tachyons.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/switching-validators-on-the-same-field/Tachyons.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		c: function create() {
			...
			div2 = element("div");
			div0 = element("div");
			t0 = text("Brazilian ID or VAT number");
			t1 = space();
			div1 = element("div");
			input = element("input");
			t2 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(div0_nodes, "Brazilian ID or VAT number");
