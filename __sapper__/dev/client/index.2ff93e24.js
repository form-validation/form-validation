...
/* src/routes/guide/validators/identical/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/identical/index.svelte";
...
// (71:12) <PrevButton target="/guide/validators/id/{slug(idData[idData.length - 1].adjective)}-identification-number">
function create_default_slot_2(ctx) {
	var t0_value = data[data.length - 1].adjective, t0, t1;
...
// (72:12) <NextButton target="/guide/validators/imei">
function create_default_slot_1(ctx) {
	var t;

	return {
		c: function create() {
			t = text("imei validator");
		},

		l: function claim(nodes) {
			t = claim_text(nodes, "imei validator");
		},
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/identical/basic",
	...
	var relatedvalidators = new RelatedValidators({
		props: { validators: ['different'] },
		$$inline: true
	});

	var prevbutton = new PrevButton({
		props: {
		target: "/guide/validators/id/" + slug(data[data.length - 1].adjective) + "-identification-number",
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("identical validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Check if the value is the same as one of given value");
			t3 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t23 = text("data-fv-identical___compare");
			t24 = space();
			td2 = element("td");
			...
			td5 = element("td");
			code3 = element("code");
			t31 = text("data-fv-identical___message");
			t32 = space();
			td6 = element("td");
			t33 = text("String");
			t34 = space();
			...
			t40 = space();
			p1 = element("p");
			t41 = text("The following form requires the password and confirmation one to be the same using ");
			code4 = element("code");
			t42 = text("identical");
			t43 = text(" validator.");
			t44 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "identical validator");
			...
			t2 = claim_text(h2_nodes, "Check if the value is the same as one of given value");
			...
			t23 = claim_text(code1_nodes, "data-fv-identical___compare");
			...
			t31 = claim_text(code3_nodes, "data-fv-identical___message");
			...
			t41 = claim_text(p1_nodes, "The following form requires the password and confirmation one to be the same using ");

			code4 = claim_element(p1_nodes, "CODE", {}, false);
			var code4_nodes = children(code4);

			t42 = claim_text(code4_nodes, "identical");
			code4_nodes.forEach(detach);
			t43 = claim_text(p1_nodes, " validator.");
		...
		h: function hydrate() {
			...
			add_location(h30, file, 11, 8, 309);
			add_location(sup0, file, 12, 29, 369);
			a.href = "/guide/plugins/declarative";
			a.className = "blue dim link";
			add_location(a, file, 12, 136, 476);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 348);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 689);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 749);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 819);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 879);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 640);
			add_location(code0, file, 21, 36, 1029);
			add_location(sup1, file, 21, 56, 1049);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 1009);
			add_location(code1, file, 22, 36, 1103);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1083);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1165);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1244);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 960);
			add_location(code2, file, 27, 36, 1418);
			td4.className = "pv2 ph3";
			add_location(td4, file, 27, 16, 1398);
			add_location(code3, file, 28, 36, 1480);
			td5.className = "pv2 ph3";
			add_location(td5, file, 28, 16, 1460);
			td6.className = "pv2 ph3";
			add_location(td6, file, 29, 16, 1542);
			td7.className = "pv2 ph3";
			add_location(td7, file, 30, 16, 1590);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 26, 12, 1349);
			table.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table, file, 13, 8, 570);
			add_location(h31, file, 34, 8, 1677);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 243);
			add_location(code4, file, 58, 110, 2282);
			p1.className = "lh-copy";
			add_location(p1, file, 58, 8, 2180);
			section1.className = "mv5";
			add_location(section1, file, 56, 4, 2109);
			div.className = "flex";
			add_location(div, file, 69, 8, 2602);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2572);
		},
		...
		p: function update(changed, ctx) {
			...
			if (changed.slug || changed.idData) prevbutton_changes.target = "/guide/validators/id/" + slug(data[data.length - 1].adjective) + "-identification-number";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • identical validator";
		},
