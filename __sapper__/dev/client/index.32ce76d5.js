...
/* src/routes/guide/validators/numeric/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/numeric/index.svelte";
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 95, 16, 4275);
			td1.className = "pv2 ph3 lh-copy";
			add_location(td1, file, 96, 16, 4354);
			td2.className = "pv2 ph3 lh-copy";
			add_location(td2, file, 97, 16, 4462);
			tr.className = "striped--light-gray";
			add_location(tr, file, 94, 16, 4226);
		},
...
function create_default_slot_4(ctx) {
	...
	return {
		c: function create() {
			...
			code1 = element("code");
			t3 = text("type=\"number\"");
			t4 = text(" for field will restrict the input to use default separators for a number (an empty string for thousands, and a dot for decimal parts).");
			this.h();
		},
		...
		l: function claim(nodes) {
			...
			t4 = claim_text(nodes, " for field will restrict the input to use default separators for a number (an empty string for thousands, and a dot for decimal parts).");
			this.h();
		},

		h: function hydrate() {
			add_location(code0, file, 116, 89, 5557);
			add_location(code1, file, 117, 18, 5611);
		},
...
// (167:12) <PrevButton target="/guide/validators/not-empty">
function create_default_slot_2(ctx) {
	var t;

	return {
		c: function create() {
			t = text("notEmpty validator");
		},

		l: function claim(nodes) {
			t = claim_text(nodes, "notEmpty validator");
		},
...
// (168:12) <NextButton target="/guide/validators/phone">
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/numeric/basic",
...
` },
	...
	var relatedvalidators = new RelatedValidators({
		props: { validators: ['digits', 'integer'] },
		$$inline: true
	});

	var prevbutton = new PrevButton({
		props: {
		target: "/guide/validators/not-empty",
	...
	return {
		c: function create() {
			...
			td1 = element("td");
			code1 = element("code");
			t21 = text("data-fv-numeric___message");
			t22 = space();
			td2 = element("td");
			t23 = text("String");
			t24 = space();
			...
			td5 = element("td");
			code3 = element("code");
			t29 = text("data-fv-numeric___thousands-separator");
			t30 = space();
			td6 = element("td");
			t31 = text("String");
			t32 = space();
			...
			td9 = element("td");
			code7 = element("code");
			t48 = text("data-fv-numeric___decimal-separator");
			t49 = space();
			td10 = element("td");
			t50 = text("String");
			t51 = space();
			...
			t99 = space();
			p5 = element("p");
			t100 = text("The following snippet shows how to use the numeric validator with ES6 module:");
			t101 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "numeric validator");
			...
			t21 = claim_text(code1_nodes, "data-fv-numeric___message");
			code1_nodes.forEach(detach);
			td1_nodes.forEach(detach);
			...
			t29 = claim_text(code3_nodes, "data-fv-numeric___thousands-separator");
			...
			t48 = claim_text(code7_nodes, "data-fv-numeric___decimal-separator");
			...
			t100 = claim_text(p5_nodes, "The following snippet shows how to use the numeric validator with ES6 module:");
		...
		h: function hydrate() {
			...
			add_location(h30, file, 11, 8, 290);
			a0.href = "/guide/plugins/declarative";
			a0.className = "blue dim link";
			add_location(a0, file, 12, 95, 416);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 329);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 633);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 693);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 763);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 823);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 584);
			add_location(code0, file, 21, 36, 973);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 953);
			add_location(code1, file, 22, 36, 1035);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1015);
			...
			add_location(tr1, file, 20, 12, 904);
			add_location(code2, file, 27, 36, 1285);
			td4.className = "pv2 ph3";
			add_location(td4, file, 27, 16, 1265);
			add_location(code3, file, 28, 36, 1358);
			td5.className = "pv2 ph3";
			add_location(td5, file, 28, 16, 1338);
			td6.className = "pv2 ph3";
			add_location(td6, file, 29, 16, 1430);
			add_location(li0, file, 33, 24, 1640);
			add_location(li1, file, 34, 24, 1709);
			add_location(code4, file, 35, 37, 1768);
			add_location(li2, file, 35, 24, 1755);
			add_location(code5, file, 36, 35, 1824);
			add_location(li3, file, 36, 24, 1813);
			ul0.className = "ma0 pl3";
			add_location(ul0, file, 32, 20, 1595);
			td7.className = "pv2 ph3 lh-copy";
			add_location(td7, file, 30, 16, 1478);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 26, 12, 1216);
			add_location(code6, file, 41, 36, 1992);
			td8.className = "pv2 ph3";
			add_location(td8, file, 41, 16, 1972);
			add_location(code7, file, 42, 36, 2063);
			td9.className = "pv2 ph3";
			add_location(td9, file, 42, 16, 2043);
			td10.className = "pv2 ph3";
			add_location(td10, file, 43, 16, 2133);
			add_location(code8, file, 47, 35, 2352);
			add_location(li4, file, 47, 24, 2341);
			add_location(code9, file, 48, 37, 2430);
			add_location(li5, file, 48, 24, 2417);
			ul1.className = "ma0 pl3";
			add_location(ul1, file, 46, 20, 2296);
			td11.className = "pv2 ph3 lh-copy";
			add_location(td11, file, 44, 16, 2181);
			tr3.className = "striped--light-gray";
			add_location(tr3, file, 40, 12, 1923);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table0, file, 13, 8, 510);
			add_location(code10, file, 53, 31, 2565);
			add_location(code11, file, 53, 67, 2601);
			span.className = "i";
			add_location(span, file, 54, 25, 2750);
			p1.className = "lh-copy";
			add_location(p1, file, 53, 8, 2542);
			add_location(h31, file, 56, 8, 2831);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 224);
			p2.className = "lh-copy";
			add_location(p2, file, 81, 8, 3370);
			p3.className = "lh-copy";
			add_location(p3, file, 82, 8, 3577);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 86, 16, 3773);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 87, 16, 3836);
			th6.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th6, file, 88, 16, 3911);
			th7.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th7, file, 89, 16, 3984);
			th8.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th8, file, 90, 16, 4046);
			tr4.className = "striped--light-gray";
			add_location(tr4, file, 85, 12, 3724);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 84, 8, 3650);
			a1.href = "/guide/api/update-validator-option";
			a1.className = "blue dim link";
			add_location(a1, file, 107, 37, 4976);
			add_location(code12, file, 107, 157, 5096);
			add_location(code13, file, 107, 193, 5132);
			add_location(p4, file, 107, 8, 4947);
			section1.className = "mv5";
			add_location(section1, file, 79, 4, 3294);
			p5.className = "lh-copy";
			add_location(p5, file, 125, 8, 5982);
			section2.className = "mv5";
			add_location(section2, file, 122, 4, 5905);
			div.className = "flex";
			add_location(div, file, 165, 8, 7051);
			section3.className = "mv5";
			add_location(section3, file, 164, 4, 7021);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • numeric validator";
		},
