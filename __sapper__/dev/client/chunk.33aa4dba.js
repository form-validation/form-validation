...
/* src/components/demo/ShoelaceLayout.svelte generated by Svelte v3.4.2 */

// (11:0) <ResourceLoader useExternalFramework="true" urls={['https://cdnjs.cloudflare.com/ajax/libs/shoelace-css/1.0.0-beta24/shoelace.css']} onLoaded={onLoaded}>
...
class ShoelaceLayout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<ShoelaceLayout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<ShoelaceLayout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { ShoelaceLayout as a, Shoelace as b };
