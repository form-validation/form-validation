...
/* src/routes/guide/validators/grid/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/grid/index.svelte";
...
function create_each_block(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(tr, file, 59, 12, 2180);
		},
...
// (99:12) <PrevButton target="/guide/validators/greater-than">
...
// (100:12) <NextButton target="/guide/validators/hex">
...
` },
	...
	var demo = new Demo({
		props: {
		prefix: "/guide/validators/grid/basic",
...
` },
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("grid validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Validate a ");
			a0 = element("a");
			t3 = text("GRId (Global Release Identifier)");
			t4 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t22 = text("data-fv-grid___message");
			t23 = space();
			td2 = element("td");
			t24 = text("String");
			t25 = space();
			...
			t31 = space();
			p1 = element("p");
			t32 = text("You can click on sample to see if it's a valid or invalid GRId.");
			t33 = space();
			...
			t40 = space();
			p2 = element("p");
			t41 = text("The following snippet shows how to use the grid validator with ES6 module:");
			t42 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "grid validator");
			...
			t3 = claim_text(a0_nodes, "GRId (Global Release Identifier)");
			...
			t22 = claim_text(code1_nodes, "data-fv-grid___message");
			...
			t32 = claim_text(p1_nodes, "You can click on sample to see if it's a valid or invalid GRId.");
			...
			t41 = claim_text(p2_nodes, "The following snippet shows how to use the grid validator with ES6 module:");
		...
		h: function hydrate() {
			...
			a0.href = "https://en.wikipedia.org/wiki/Global_Release_Identifier";
			a0.className = "blue dim link";
			add_location(a0, file, 6, 37, 181);
			h2.className = "f4 fw4 tc";
			add_location(h2, file, 6, 4, 148);
			add_location(h30, file, 11, 8, 382);
			a1.href = "/guide/plugins/declarative";
			a1.className = "blue dim link";
			add_location(a1, file, 12, 95, 508);
			p0.className = "lh-copy i";
			add_location(p0, file, 12, 8, 421);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 721);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 781);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 851);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 911);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 672);
			add_location(code0, file, 21, 36, 1061);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 1041);
			add_location(code1, file, 22, 36, 1123);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1103);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1180);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1228);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 992);
			table0.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table0, file, 13, 8, 602);
			add_location(h31, file, 28, 8, 1315);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 316);
			p1.className = "lh-copy";
			add_location(p1, file, 52, 8, 1782);
			th4.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th4, file, 55, 16, 2000);
			th5.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th5, file, 56, 16, 2062);
			tr2.className = "striped--light-gray";
			add_location(tr2, file, 54, 12, 1951);
			table1.className = "collapse ba br2 b--black-10 pv2 ph3 w-100 mb4";
			add_location(table1, file, 53, 8, 1877);
			section1.className = "mv5";
			add_location(section1, file, 49, 4, 1710);
			p2.className = "lh-copy";
			add_location(p2, file, 71, 8, 2545);
			section2.className = "mv5";
			add_location(section2, file, 68, 4, 2468);
			div.className = "flex";
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • grid validator";
		},
