...
/* src/routes/guide/examples/showing-dynamic-message/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/examples/showing-dynamic-message/Bootstrap.svelte";
...
function create_default_slot(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Password");
