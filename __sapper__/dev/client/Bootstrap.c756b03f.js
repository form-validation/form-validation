...
/* src/routes/guide/validators/ein/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/ein/basic/Bootstrap.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		h: function hydrate() {
			...
			add_location(label, file, 4, 16, 247);
			attr(input, "type", "text");
			input.className = "form-control";
			input.name = "ein";
			add_location(input, file, 6, 20, 357);
			div0.className = "col-sm-5";
			add_location(div0, file, 5, 16, 314);
