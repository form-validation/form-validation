...
/* src/components/demo/MiniLayout.svelte generated by Svelte v3.4.2 */

// (17:0) <ResourceLoader useExternalFramework="true" urls={['https://cdnjs.cloudflare.com/ajax/libs/mini.css/3.0.1/mini-default.min.css']} onLoaded={onLoaded}>
...
class MiniLayout extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get onLoaded() {
		throw new Error("<MiniLayout>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set onLoaded(value) {
		throw new Error("<MiniLayout>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { MiniLayout as a, Mini as b };
