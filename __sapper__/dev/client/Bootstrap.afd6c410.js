...
/* src/routes/guide/validators/credit-card/basic/Bootstrap.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/credit-card/basic/Bootstrap.svelte";
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(label_nodes, "Credit card number");
		...
		h: function hydrate() {
			...
			add_location(label, file, 4, 16, 255);
			attr(input, "type", "text");
			input.className = "form-control";
			input.name = "cc";
			add_location(input, file, 6, 20, 380);
			div0.className = "col-sm-5";
			add_location(div0, file, 5, 16, 337);
			div1.className = "form-group row";
			add_location(div1, file, 3, 12, 210);
			form.id = "demoForm";
			form.method = "POST";
			add_location(form, file, 2, 8, 163);
		},
