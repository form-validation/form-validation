...
/* src/routes/guide/validators/digits/index.svelte generated by Svelte v3.4.2 */

const file = "src/routes/guide/validators/digits/index.svelte";
...
// (54:12) <PrevButton target="/guide/validators/different">
...
// (55:12) <NextButton target="/guide/validators/ean">
...
` },
	...
	var relatedvalidators = new RelatedValidators({
		props: { validators: ['integer', 'numeric'] },
		$$inline: true
	});
	...
	return {
		c: function create() {
			h1 = element("h1");
			t0 = text("digits validator");
			t1 = space();
			h2 = element("h2");
			t2 = text("Check if the input contains only digits");
			t3 = space();
			...
			td1 = element("td");
			code1 = element("code");
			t21 = text("data-fv-digits___message");
			t22 = space();
			td2 = element("td");
			t23 = text("String");
			t24 = space();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "digits validator");
			...
			t2 = claim_text(h2_nodes, "Check if the input contains only digits");
			...
			t21 = claim_text(code1_nodes, "data-fv-digits___message");
		...
		h: function hydrate() {
			...
			add_location(a, file, 12, 95, 416);
			p.className = "lh-copy i";
			add_location(p, file, 12, 8, 329);
			th0.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th0, file, 15, 16, 629);
			th1.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th1, file, 16, 16, 689);
			th2.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th2, file, 17, 16, 759);
			th3.className = "pv2 ph3 tl f6 fw6 ttu";
			add_location(th3, file, 18, 16, 819);
			tr0.className = "striped--light-gray";
			add_location(tr0, file, 14, 12, 580);
			add_location(code0, file, 21, 36, 969);
			td0.className = "pv2 ph3";
			add_location(td0, file, 21, 16, 949);
			add_location(code1, file, 22, 36, 1031);
			td1.className = "pv2 ph3";
			add_location(td1, file, 22, 16, 1011);
			td2.className = "pv2 ph3";
			add_location(td2, file, 23, 16, 1090);
			td3.className = "pv2 ph3";
			add_location(td3, file, 24, 16, 1138);
			tr1.className = "striped--light-gray";
			add_location(tr1, file, 20, 12, 900);
			table.className = "collapse ba br2 b--black-10 pv2 ph3 w-100";
			add_location(table, file, 13, 8, 510);
			add_location(h31, file, 28, 8, 1225);
			section0.className = "mv5";
			add_location(section0, file, 8, 4, 224);
			div.className = "flex";
			add_location(div, file, 52, 8, 1719);
			section1.className = "mv5";
			add_location(section1, file, 51, 4, 1689);
		},
...
function create_fragment(ctx) {
	...
	return {
		...
		h: function hydrate() {
			document.title = "FormValidation • digits validator";
		},
